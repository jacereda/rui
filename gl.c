...
static GLboolean GL_APIENTRY
_impl_glIsVertexArray(GLuint array)
{
	_glptr_glIsVertexArray =
	    (PFN_glIsVertexArray)GalogenGetProcAddress("glIsVertexArray");
...
_impl_glBindVertexArray(GLuint array)
{
	_glptr_glBindVertexArray =
	    (PFN_glBindVertexArray)GalogenGetProcAddress("glBindVertexArray");
	_glptr_glBindVertexArray(array);
}
PFN_glBindVertexArray _glptr_glBindVertexArray = _impl_glBindVertexArray;

static void GL_APIENTRY
_impl_glFlushMappedBufferRange(
    GLenum target, GLintptr offset, GLsizeiptr length)
{
	_glptr_glFlushMappedBufferRange =
	    (PFN_glFlushMappedBufferRange)GalogenGetProcAddress(
		"glFlushMappedBufferRange");
	_glptr_glFlushMappedBufferRange(target, offset, length);
}
PFN_glFlushMappedBufferRange _glptr_glFlushMappedBufferRange =
    _impl_glFlushMappedBufferRange;

static void *GL_APIENTRY
_impl_glMapBufferRange(
    GLenum target, GLintptr offset, GLsizeiptr length, GLbitfield access)
{
	_glptr_glMapBufferRange =
	    (PFN_glMapBufferRange)GalogenGetProcAddress("glMapBufferRange");
...
static void GL_APIENTRY
_impl_glFramebufferTextureLayer(
    GLenum target, GLenum attachment, GLuint texture, GLint level, GLint layer)
{
	_glptr_glFramebufferTextureLayer =
	    (PFN_glFramebufferTextureLayer)GalogenGetProcAddress(
		"glFramebufferTextureLayer");
	_glptr_glFramebufferTextureLayer(
	    target, attachment, texture, level, layer);
}
PFN_glFramebufferTextureLayer _glptr_glFramebufferTextureLayer =
    _impl_glFramebufferTextureLayer;
    ...
    GLenum target, GLenum attachment, GLenum pname, GLint *params)
{
	_glptr_glGetFramebufferAttachmentParameteriv =
	    (PFN_glGetFramebufferAttachmentParameteriv)GalogenGetProcAddress(
...
static void GL_APIENTRY
_impl_glFramebufferTexture3D(GLenum target, GLenum attachment, GLenum textarget,
    GLuint texture, GLint level, GLint zoffset)
{
	_glptr_glFramebufferTexture3D =
	    (PFN_glFramebufferTexture3D)GalogenGetProcAddress(
		"glFramebufferTexture3D");
	_glptr_glFramebufferTexture3D(
	    target, attachment, textarget, texture, level, zoffset);
}
PFN_glFramebufferTexture3D _glptr_glFramebufferTexture3D =
    _impl_glFramebufferTexture3D;

static void GL_APIENTRY
_impl_glFramebufferTexture1D(GLenum target, GLenum attachment, GLenum textarget,
    GLuint texture, GLint level)
{
	_glptr_glFramebufferTexture1D =
	    (PFN_glFramebufferTexture1D)GalogenGetProcAddress(
		"glFramebufferTexture1D");
	_glptr_glFramebufferTexture1D(
	    target, attachment, textarget, texture, level);
}
PFN_glFramebufferTexture1D _glptr_glFramebufferTexture1D =
    _impl_glFramebufferTexture1D;

static void GL_APIENTRY
_impl_glGenFramebuffers(GLsizei n, GLuint *framebuffers)
{
	_glptr_glGenFramebuffers =
	    (PFN_glGenFramebuffers)GalogenGetProcAddress("glGenFramebuffers");
	_glptr_glGenFramebuffers(n, framebuffers);
}
PFN_glGenFramebuffers _glptr_glGenFramebuffers = _impl_glGenFramebuffers;

static void GL_APIENTRY
_impl_glBindFramebuffer(GLenum target, GLuint framebuffer)
{
	_glptr_glBindFramebuffer =
	    (PFN_glBindFramebuffer)GalogenGetProcAddress("glBindFramebuffer");
	_glptr_glBindFramebuffer(target, framebuffer);
}
PFN_glBindFramebuffer _glptr_glBindFramebuffer = _impl_glBindFramebuffer;

static GLboolean GL_APIENTRY
_impl_glIsFramebuffer(GLuint framebuffer)
{
	_glptr_glIsFramebuffer =
	    (PFN_glIsFramebuffer)GalogenGetProcAddress("glIsFramebuffer");
	return _glptr_glIsFramebuffer(framebuffer);
}
PFN_glIsFramebuffer _glptr_glIsFramebuffer = _impl_glIsFramebuffer;

static void GL_APIENTRY
_impl_glGetRenderbufferParameteriv(GLenum target, GLenum pname, GLint *params)
{
	_glptr_glGetRenderbufferParameteriv =
	    (PFN_glGetRenderbufferParameteriv)GalogenGetProcAddress(
		"glGetRenderbufferParameteriv");
	_glptr_glGetRenderbufferParameteriv(target, pname, params);
}
PFN_glGetRenderbufferParameteriv _glptr_glGetRenderbufferParameteriv =
    _impl_glGetRenderbufferParameteriv;

static void GL_APIENTRY
_impl_glBindRenderbuffer(GLenum target, GLuint renderbuffer)
{
	_glptr_glBindRenderbuffer =
	    (PFN_glBindRenderbuffer)GalogenGetProcAddress("glBindRenderbuffer");
	_glptr_glBindRenderbuffer(target, renderbuffer);
}
PFN_glBindRenderbuffer _glptr_glBindRenderbuffer = _impl_glBindRenderbuffer;

static GLboolean GL_APIENTRY
_impl_glIsRenderbuffer(GLuint renderbuffer)
{
	_glptr_glIsRenderbuffer =
	    (PFN_glIsRenderbuffer)GalogenGetProcAddress("glIsRenderbuffer");
	return _glptr_glIsRenderbuffer(renderbuffer);
}
PFN_glIsRenderbuffer _glptr_glIsRenderbuffer = _impl_glIsRenderbuffer;

static const GLubyte *GL_APIENTRY
_impl_glGetStringi(GLenum name, GLuint index)
{
	_glptr_glGetStringi =
	    (PFN_glGetStringi)GalogenGetProcAddress("glGetStringi");
	return _glptr_glGetStringi(name, index);
}
PFN_glGetStringi _glptr_glGetStringi = _impl_glGetStringi;

static void GL_APIENTRY
_impl_glClearBufferfi(
    GLenum buffer, GLint drawbuffer, GLfloat depth, GLint stencil)
{
	_glptr_glClearBufferfi =
	    (PFN_glClearBufferfi)GalogenGetProcAddress("glClearBufferfi");
	_glptr_glClearBufferfi(buffer, drawbuffer, depth, stencil);
}
PFN_glClearBufferfi _glptr_glClearBufferfi = _impl_glClearBufferfi;

static void GL_APIENTRY
_impl_glClearBufferfv(GLenum buffer, GLint drawbuffer, const GLfloat *value)
{
	_glptr_glClearBufferfv =
	    (PFN_glClearBufferfv)GalogenGetProcAddress("glClearBufferfv");
	_glptr_glClearBufferfv(buffer, drawbuffer, value);
}
PFN_glClearBufferfv _glptr_glClearBufferfv = _impl_glClearBufferfv;

static void GL_APIENTRY
_impl_glGetTexParameterIiv(GLenum target, GLenum pname, GLint *params)
{
	_glptr_glGetTexParameterIiv =
	    (PFN_glGetTexParameterIiv)GalogenGetProcAddress(
		"glGetTexParameterIiv");
	_glptr_glGetTexParameterIiv(target, pname, params);
}
PFN_glGetTexParameterIiv _glptr_glGetTexParameterIiv =
    _impl_glGetTexParameterIiv;

static void GL_APIENTRY
_impl_glTexParameterIiv(GLenum target, GLenum pname, const GLint *params)
{
	_glptr_glTexParameterIiv =
	    (PFN_glTexParameterIiv)GalogenGetProcAddress("glTexParameterIiv");
	_glptr_glTexParameterIiv(target, pname, params);
}
PFN_glTexParameterIiv _glptr_glTexParameterIiv = _impl_glTexParameterIiv;

static void GL_APIENTRY
_impl_glUniform4uiv(GLint location, GLsizei count, const GLuint *value)
{
	_glptr_glUniform4uiv =
	    (PFN_glUniform4uiv)GalogenGetProcAddress("glUniform4uiv");
	_glptr_glUniform4uiv(location, count, value);
}
PFN_glUniform4uiv _glptr_glUniform4uiv = _impl_glUniform4uiv;

static void GL_APIENTRY
_impl_glUniform3ui(GLint location, GLuint v0, GLuint v1, GLuint v2)
{
	_glptr_glUniform3ui =
	    (PFN_glUniform3ui)GalogenGetProcAddress("glUniform3ui");
	_glptr_glUniform3ui(location, v0, v1, v2);
}
PFN_glUniform3ui _glptr_glUniform3ui = _impl_glUniform3ui;

static void GL_APIENTRY
_impl_glUniform1ui(GLint location, GLuint v0)
{
	_glptr_glUniform1ui =
	    (PFN_glUniform1ui)GalogenGetProcAddress("glUniform1ui");
	_glptr_glUniform1ui(location, v0);
}
PFN_glUniform1ui _glptr_glUniform1ui = _impl_glUniform1ui;

static GLint GL_APIENTRY
_impl_glGetFragDataLocation(GLuint program, const GLchar *name)
{
	_glptr_glGetFragDataLocation =
	    (PFN_glGetFragDataLocation)GalogenGetProcAddress(
		"glGetFragDataLocation");
	return _glptr_glGetFragDataLocation(program, name);
}
PFN_glGetFragDataLocation _glptr_glGetFragDataLocation =
    _impl_glGetFragDataLocation;

static void GL_APIENTRY
_impl_glBindFragDataLocation(GLuint program, GLuint color, const GLchar *name)
{
	_glptr_glBindFragDataLocation =
	    (PFN_glBindFragDataLocation)GalogenGetProcAddress(
		"glBindFragDataLocation");
	_glptr_glBindFragDataLocation(program, color, name);
}
PFN_glBindFragDataLocation _glptr_glBindFragDataLocation =
    _impl_glBindFragDataLocation;

static void GL_APIENTRY
_impl_glVertexAttribI4iv(GLuint index, const GLint *v)
{
	_glptr_glVertexAttribI4iv =
	    (PFN_glVertexAttribI4iv)GalogenGetProcAddress("glVertexAttribI4iv");
	_glptr_glVertexAttribI4iv(index, v);
}
PFN_glVertexAttribI4iv _glptr_glVertexAttribI4iv = _impl_glVertexAttribI4iv;

static void GL_APIENTRY
_impl_glVertexAttribI2iv(GLuint index, const GLint *v)
{
	_glptr_glVertexAttribI2iv =
	    (PFN_glVertexAttribI2iv)GalogenGetProcAddress("glVertexAttribI2iv");
	_glptr_glVertexAttribI2iv(index, v);
}
PFN_glVertexAttribI2iv _glptr_glVertexAttribI2iv = _impl_glVertexAttribI2iv;

static void GL_APIENTRY
_impl_glVertexAttribI1iv(GLuint index, const GLint *v)
{
	_glptr_glVertexAttribI1iv =
	    (PFN_glVertexAttribI1iv)GalogenGetProcAddress("glVertexAttribI1iv");
	_glptr_glVertexAttribI1iv(index, v);
}
PFN_glVertexAttribI1iv _glptr_glVertexAttribI1iv = _impl_glVertexAttribI1iv;

static void GL_APIENTRY
_impl_glVertexAttribI4ui(GLuint index, GLuint x, GLuint y, GLuint z, GLuint w)
{
	_glptr_glVertexAttribI4ui =
	    (PFN_glVertexAttribI4ui)GalogenGetProcAddress("glVertexAttribI4ui");
	_glptr_glVertexAttribI4ui(index, x, y, z, w);
}
PFN_glVertexAttribI4ui _glptr_glVertexAttribI4ui = _impl_glVertexAttribI4ui;

static void GL_APIENTRY
_impl_glVertexAttribI2ui(GLuint index, GLuint x, GLuint y)
{
	_glptr_glVertexAttribI2ui =
	    (PFN_glVertexAttribI2ui)GalogenGetProcAddress("glVertexAttribI2ui");
	_glptr_glVertexAttribI2ui(index, x, y);
}
PFN_glVertexAttribI2ui _glptr_glVertexAttribI2ui = _impl_glVertexAttribI2ui;

static void GL_APIENTRY
_impl_glVertexAttribI1ui(GLuint index, GLuint x)
{
	_glptr_glVertexAttribI1ui =
	    (PFN_glVertexAttribI1ui)GalogenGetProcAddress("glVertexAttribI1ui");
	_glptr_glVertexAttribI1ui(index, x);
}
PFN_glVertexAttribI1ui _glptr_glVertexAttribI1ui = _impl_glVertexAttribI1ui;

static void GL_APIENTRY
_impl_glVertexAttribI4i(GLuint index, GLint x, GLint y, GLint z, GLint w)
{
	_glptr_glVertexAttribI4i =
	    (PFN_glVertexAttribI4i)GalogenGetProcAddress("glVertexAttribI4i");
	_glptr_glVertexAttribI4i(index, x, y, z, w);
}
PFN_glVertexAttribI4i _glptr_glVertexAttribI4i = _impl_glVertexAttribI4i;

static void GL_APIENTRY
_impl_glVertexAttribI4bv(GLuint index, const GLbyte *v)
{
	_glptr_glVertexAttribI4bv =
	    (PFN_glVertexAttribI4bv)GalogenGetProcAddress("glVertexAttribI4bv");
	_glptr_glVertexAttribI4bv(index, v);
}
PFN_glVertexAttribI4bv _glptr_glVertexAttribI4bv = _impl_glVertexAttribI4bv;

static void GL_APIENTRY
_impl_glVertexAttribI2i(GLuint index, GLint x, GLint y)
{
	_glptr_glVertexAttribI2i =
	    (PFN_glVertexAttribI2i)GalogenGetProcAddress("glVertexAttribI2i");
	_glptr_glVertexAttribI2i(index, x, y);
}
PFN_glVertexAttribI2i _glptr_glVertexAttribI2i = _impl_glVertexAttribI2i;

static void GL_APIENTRY
_impl_glVertexAttribI1i(GLuint index, GLint x)
{
	_glptr_glVertexAttribI1i =
	    (PFN_glVertexAttribI1i)GalogenGetProcAddress("glVertexAttribI1i");
	_glptr_glVertexAttribI1i(index, x);
}
PFN_glVertexAttribI1i _glptr_glVertexAttribI1i = _impl_glVertexAttribI1i;

static void GL_APIENTRY
_impl_glGetVertexAttribIiv(GLuint index, GLenum pname, GLint *params)
{
	_glptr_glGetVertexAttribIiv =
	    (PFN_glGetVertexAttribIiv)GalogenGetProcAddress(
		"glGetVertexAttribIiv");
	_glptr_glGetVertexAttribIiv(index, pname, params);
}
PFN_glGetVertexAttribIiv _glptr_glGetVertexAttribIiv =
    _impl_glGetVertexAttribIiv;

static void GL_APIENTRY
_impl_glVertexAttribIPointer(
    GLuint index, GLint size, GLenum type, GLsizei stride, const void *pointer)
{
	_glptr_glVertexAttribIPointer =
	    (PFN_glVertexAttribIPointer)GalogenGetProcAddress(
		"glVertexAttribIPointer");
	_glptr_glVertexAttribIPointer(index, size, type, stride, pointer);
}
PFN_glVertexAttribIPointer _glptr_glVertexAttribIPointer =
    _impl_glVertexAttribIPointer;

static void GL_APIENTRY
_impl_glBeginConditionalRender(GLuint id, GLenum mode)
{
	_glptr_glBeginConditionalRender =
	    (PFN_glBeginConditionalRender)GalogenGetProcAddress(
		"glBeginConditionalRender");
	_glptr_glBeginConditionalRender(id, mode);
}
PFN_glBeginConditionalRender _glptr_glBeginConditionalRender =
    _impl_glBeginConditionalRender;

static void GL_APIENTRY
_impl_glClampColor(GLenum target, GLenum clamp)
{
	_glptr_glClampColor =
	    (PFN_glClampColor)GalogenGetProcAddress("glClampColor");
	_glptr_glClampColor(target, clamp);
}
PFN_glClampColor _glptr_glClampColor = _impl_glClampColor;

static void GL_APIENTRY
_impl_glBindBufferBase(GLenum target, GLuint index, GLuint buffer)
{
	_glptr_glBindBufferBase =
	    (PFN_glBindBufferBase)GalogenGetProcAddress("glBindBufferBase");
	_glptr_glBindBufferBase(target, index, buffer);
}
PFN_glBindBufferBase _glptr_glBindBufferBase = _impl_glBindBufferBase;

static void GL_APIENTRY
_impl_glBindBufferRange(GLenum target, GLuint index, GLuint buffer,
    GLintptr offset, GLsizeiptr size)
{
	_glptr_glBindBufferRange =
	    (PFN_glBindBufferRange)GalogenGetProcAddress("glBindBufferRange");
...
static void GL_APIENTRY
_impl_glBeginTransformFeedback(GLenum primitiveMode)
{
	_glptr_glBeginTransformFeedback =
	    (PFN_glBeginTransformFeedback)GalogenGetProcAddress(
		"glBeginTransformFeedback");
	_glptr_glBeginTransformFeedback(primitiveMode);
}
PFN_glBeginTransformFeedback _glptr_glBeginTransformFeedback =
    _impl_glBeginTransformFeedback;

static GLboolean GL_APIENTRY
_impl_glIsEnabledi(GLenum target, GLuint index)
{
	_glptr_glIsEnabledi =
	    (PFN_glIsEnabledi)GalogenGetProcAddress("glIsEnabledi");
	return _glptr_glIsEnabledi(target, index);
}
PFN_glIsEnabledi _glptr_glIsEnabledi = _impl_glIsEnabledi;

static void GL_APIENTRY
_impl_glGetIntegeri_v(GLenum target, GLuint index, GLint *data)
{
	_glptr_glGetIntegeri_v =
	    (PFN_glGetIntegeri_v)GalogenGetProcAddress("glGetIntegeri_v");
...
PFN_glUniformMatrix4x3fv _glptr_glUniformMatrix4x3fv =
    _impl_glUniformMatrix4x3fv;

static void GL_APIENTRY
_impl_glUniformMatrix3x4fv(
    GLint location, GLsizei count, GLboolean transpose, const GLfloat *value)
{
	_glptr_glUniformMatrix3x4fv =
	    (PFN_glUniformMatrix3x4fv)GalogenGetProcAddress(
		"glUniformMatrix3x4fv");
	_glptr_glUniformMatrix3x4fv(location, count, transpose, value);
}
PFN_glUniformMatrix3x4fv _glptr_glUniformMatrix3x4fv =
    _impl_glUniformMatrix3x4fv;
    ...
    GLint location, GLsizei count, GLboolean transpose, const GLfloat *value)
{
	_glptr_glUniformMatrix2x4fv =
	    (PFN_glUniformMatrix2x4fv)GalogenGetProcAddress(
		"glUniformMatrix2x4fv");
	_glptr_glUniformMatrix2x4fv(location, count, transpose, value);
}
PFN_glUniformMatrix2x4fv _glptr_glUniformMatrix2x4fv =
    _impl_glUniformMatrix2x4fv;

static void GL_APIENTRY
_impl_glUniformMatrix3x2fv(
    GLint location, GLsizei count, GLboolean transpose, const GLfloat *value)
{
...
PFN_glUniformMatrix3x2fv _glptr_glUniformMatrix3x2fv =
    _impl_glUniformMatrix3x2fv;

static void GL_APIENTRY
_impl_glUniformMatrix2x3fv(
    GLint location, GLsizei count, GLboolean transpose, const GLfloat *value)
{
	_glptr_glUniformMatrix2x3fv =
	    (PFN_glUniformMatrix2x3fv)GalogenGetProcAddress(
		"glUniformMatrix2x3fv");
	_glptr_glUniformMatrix2x3fv(location, count, transpose, value);
}
PFN_glUniformMatrix2x3fv _glptr_glUniformMatrix2x3fv =
    _impl_glUniformMatrix2x3fv;

static void GL_APIENTRY
_impl_glVertexAttrib4ubv(GLuint index, const GLubyte *v)
{
...
static void GL_APIENTRY
_impl_glVertexAttrib4sv(GLuint index, const GLshort *v)
{
	_glptr_glVertexAttrib4sv =
	    (PFN_glVertexAttrib4sv)GalogenGetProcAddress("glVertexAttrib4sv");
	_glptr_glVertexAttrib4sv(index, v);
}
PFN_glVertexAttrib4sv _glptr_glVertexAttrib4sv = _impl_glVertexAttrib4sv;

static void GL_APIENTRY
_impl_glVertexAttrib4fv(GLuint index, const GLfloat *v)
{
	_glptr_glVertexAttrib4fv =
	    (PFN_glVertexAttrib4fv)GalogenGetProcAddress("glVertexAttrib4fv");
	_glptr_glVertexAttrib4fv(index, v);
}
PFN_glVertexAttrib4fv _glptr_glVertexAttrib4fv = _impl_glVertexAttrib4fv;

static void GL_APIENTRY
_impl_glVertexAttrib4Nusv(GLuint index, const GLushort *v)
{
	_glptr_glVertexAttrib4Nusv =
	    (PFN_glVertexAttrib4Nusv)GalogenGetProcAddress(
		"glVertexAttrib4Nusv");
...
static void GL_APIENTRY
_impl_glVertexAttrib4Nuiv(GLuint index, const GLuint *v)
{
	_glptr_glVertexAttrib4Nuiv =
	    (PFN_glVertexAttrib4Nuiv)GalogenGetProcAddress(
		"glVertexAttrib4Nuiv");
...
static void GL_APIENTRY
_impl_glVertexAttrib4Nubv(GLuint index, const GLubyte *v)
{
	_glptr_glVertexAttrib4Nubv =
	    (PFN_glVertexAttrib4Nubv)GalogenGetProcAddress(
		"glVertexAttrib4Nubv");
...
static void GL_APIENTRY
_impl_glVertexAttrib4Nsv(GLuint index, const GLshort *v)
{
	_glptr_glVertexAttrib4Nsv =
	    (PFN_glVertexAttrib4Nsv)GalogenGetProcAddress("glVertexAttrib4Nsv");
	_glptr_glVertexAttrib4Nsv(index, v);
}
PFN_glVertexAttrib4Nsv _glptr_glVertexAttrib4Nsv = _impl_glVertexAttrib4Nsv;

static void GL_APIENTRY
_impl_glVertexAttrib3f(GLuint index, GLfloat x, GLfloat y, GLfloat z)
{
	_glptr_glVertexAttrib3f =
	    (PFN_glVertexAttrib3f)GalogenGetProcAddress("glVertexAttrib3f");
	_glptr_glVertexAttrib3f(index, x, y, z);
}
PFN_glVertexAttrib3f _glptr_glVertexAttrib3f = _impl_glVertexAttrib3f;

static void GL_APIENTRY
_impl_glVertexAttribI1uiv(GLuint index, const GLuint *v)
{
	_glptr_glVertexAttribI1uiv =
	    (PFN_glVertexAttribI1uiv)GalogenGetProcAddress(
		"glVertexAttribI1uiv");
...
static void GL_APIENTRY
_impl_glDeleteRenderbuffers(GLsizei n, const GLuint *renderbuffers)
{
	_glptr_glDeleteRenderbuffers =
	    (PFN_glDeleteRenderbuffers)GalogenGetProcAddress(
		"glDeleteRenderbuffers");
	_glptr_glDeleteRenderbuffers(n, renderbuffers);
}
PFN_glDeleteRenderbuffers _glptr_glDeleteRenderbuffers =
    _impl_glDeleteRenderbuffers;

static void GL_APIENTRY
_impl_glUniformMatrix2fv(
    GLint location, GLsizei count, GLboolean transpose, const GLfloat *value)
{
	_glptr_glUniformMatrix2fv =
	    (PFN_glUniformMatrix2fv)GalogenGetProcAddress("glUniformMatrix2fv");
...
static void GL_APIENTRY
_impl_glUniform4iv(GLint location, GLsizei count, const GLint *value)
{
	_glptr_glUniform4iv =
	    (PFN_glUniform4iv)GalogenGetProcAddress("glUniform4iv");
	_glptr_glUniform4iv(location, count, value);
}
PFN_glUniform4iv _glptr_glUniform4iv = _impl_glUniform4iv;

static void GL_APIENTRY
_impl_glUniform1iv(GLint location, GLsizei count, const GLint *value)
{
	_glptr_glUniform1iv =
	    (PFN_glUniform1iv)GalogenGetProcAddress("glUniform1iv");
	_glptr_glUniform1iv(location, count, value);
}
PFN_glUniform1iv _glptr_glUniform1iv = _impl_glUniform1iv;

static void GL_APIENTRY
_impl_glUniform4fv(GLint location, GLsizei count, const GLfloat *value)
{
	_glptr_glUniform4fv =
	    (PFN_glUniform4fv)GalogenGetProcAddress("glUniform4fv");
	_glptr_glUniform4fv(location, count, value);
}
PFN_glUniform4fv _glptr_glUniform4fv = _impl_glUniform4fv;

static void GL_APIENTRY
_impl_glUniform2fv(GLint location, GLsizei count, const GLfloat *value)
{
	_glptr_glUniform2fv =
	    (PFN_glUniform2fv)GalogenGetProcAddress("glUniform2fv");
	_glptr_glUniform2fv(location, count, value);
}
PFN_glUniform2fv _glptr_glUniform2fv = _impl_glUniform2fv;

static void GL_APIENTRY
_impl_glUniform3i(GLint location, GLint v0, GLint v1, GLint v2)
{
	_glptr_glUniform3i =
	    (PFN_glUniform3i)GalogenGetProcAddress("glUniform3i");
	_glptr_glUniform3i(location, v0, v1, v2);
}
PFN_glUniform3i _glptr_glUniform3i = _impl_glUniform3i;

static void GL_APIENTRY
_impl_glUniform2i(GLint location, GLint v0, GLint v1)
{
	_glptr_glUniform2i =
	    (PFN_glUniform2i)GalogenGetProcAddress("glUniform2i");
...
{
	_glptr_glUniform4f =
	    (PFN_glUniform4f)GalogenGetProcAddress("glUniform4f");
	_glptr_glUniform4f(location, v0, v1, v2, v3);
}
PFN_glUniform4f _glptr_glUniform4f = _impl_glUniform4f;

static void GL_APIENTRY
_impl_glUniform3f(GLint location, GLfloat v0, GLfloat v1, GLfloat v2)
{
	_glptr_glUniform3f =
	    (PFN_glUniform3f)GalogenGetProcAddress("glUniform3f");
	_glptr_glUniform3f(location, v0, v1, v2);
}
PFN_glUniform3f _glptr_glUniform3f = _impl_glUniform3f;

static void GL_APIENTRY
_impl_glUniform1f(GLint location, GLfloat v0)
{
	_glptr_glUniform1f =
	    (PFN_glUniform1f)GalogenGetProcAddress("glUniform1f");
	_glptr_glUniform1f(location, v0);
}
PFN_glUniform1f _glptr_glUniform1f = _impl_glUniform1f;

static void GL_APIENTRY
_impl_glUseProgram(GLuint program)
{
	_glptr_glUseProgram =
	    (PFN_glUseProgram)GalogenGetProcAddress("glUseProgram");
	_glptr_glUseProgram(program);
}
PFN_glUseProgram _glptr_glUseProgram = _impl_glUseProgram;

static void GL_APIENTRY
_impl_glShaderSource(GLuint shader, GLsizei count, const GLchar *const *string,
    const GLint *length)
{
	_glptr_glShaderSource =
	    (PFN_glShaderSource)GalogenGetProcAddress("glShaderSource");
	_glptr_glShaderSource(shader, count, string, length);
}
PFN_glShaderSource _glptr_glShaderSource = _impl_glShaderSource;

static void GL_APIENTRY
_impl_glLinkProgram(GLuint program)
{
	_glptr_glLinkProgram =
	    (PFN_glLinkProgram)GalogenGetProcAddress("glLinkProgram");
	_glptr_glLinkProgram(program);
}
PFN_glLinkProgram _glptr_glLinkProgram = _impl_glLinkProgram;

static GLboolean GL_APIENTRY
_impl_glIsShader(GLuint shader)
{
...
static void GL_APIENTRY
_impl_glGetVertexAttribPointerv(GLuint index, GLenum pname, void **pointer)
{
	_glptr_glGetVertexAttribPointerv =
	    (PFN_glGetVertexAttribPointerv)GalogenGetProcAddress(
		"glGetVertexAttribPointerv");
	_glptr_glGetVertexAttribPointerv(index, pname, pointer);
}
PFN_glGetVertexAttribPointerv _glptr_glGetVertexAttribPointerv =
    _impl_glGetVertexAttribPointerv;

static void GL_APIENTRY
_impl_glGetVertexAttribiv(GLuint index, GLenum pname, GLint *params)
{
	_glptr_glGetVertexAttribiv =
	    (PFN_glGetVertexAttribiv)GalogenGetProcAddress(
		"glGetVertexAttribiv");
...
static void GL_APIENTRY
_impl_glGetVertexAttribfv(GLuint index, GLenum pname, GLfloat *params)
{
	_glptr_glGetVertexAttribfv =
	    (PFN_glGetVertexAttribfv)GalogenGetProcAddress(
		"glGetVertexAttribfv");
...
static GLint GL_APIENTRY
_impl_glGetUniformLocation(GLuint program, const GLchar *name)
{
	_glptr_glGetUniformLocation =
	    (PFN_glGetUniformLocation)GalogenGetProcAddress(
		"glGetUniformLocation");
	return _glptr_glGetUniformLocation(program, name);
}
PFN_glGetUniformLocation _glptr_glGetUniformLocation =
    _impl_glGetUniformLocation;

static void GL_APIENTRY
_impl_glGetShaderiv(GLuint shader, GLenum pname, GLint *params)
{
	_glptr_glGetShaderiv =
	    (PFN_glGetShaderiv)GalogenGetProcAddress("glGetShaderiv");
	_glptr_glGetShaderiv(shader, pname, params);
}
PFN_glGetShaderiv _glptr_glGetShaderiv = _impl_glGetShaderiv;

static void GL_APIENTRY
_impl_glGetProgramInfoLog(
    GLuint program, GLsizei bufSize, GLsizei *length, GLchar *infoLog)
{
	_glptr_glGetProgramInfoLog =
	    (PFN_glGetProgramInfoLog)GalogenGetProcAddress(
		"glGetProgramInfoLog");
...
static GLint GL_APIENTRY
_impl_glGetAttribLocation(GLuint program, const GLchar *name)
{
	_glptr_glGetAttribLocation =
	    (PFN_glGetAttribLocation)GalogenGetProcAddress(
		"glGetAttribLocation");
...
static void GL_APIENTRY
_impl_glGetAttachedShaders(
    GLuint program, GLsizei maxCount, GLsizei *count, GLuint *shaders)
{
	_glptr_glGetAttachedShaders =
	    (PFN_glGetAttachedShaders)GalogenGetProcAddress(
		"glGetAttachedShaders");
	_glptr_glGetAttachedShaders(program, maxCount, count, shaders);
}
PFN_glGetAttachedShaders _glptr_glGetAttachedShaders =
    _impl_glGetAttachedShaders;

static void GL_APIENTRY
_impl_glGetActiveUniform(GLuint program, GLuint index, GLsizei bufSize,
    GLsizei *length, GLint *size, GLenum *type, GLchar *name)
{
	_glptr_glGetActiveUniform =
	    (PFN_glGetActiveUniform)GalogenGetProcAddress("glGetActiveUniform");
	_glptr_glGetActiveUniform(
...
static void GL_APIENTRY
_impl_glGetActiveAttrib(GLuint program, GLuint index, GLsizei bufSize,
    GLsizei *length, GLint *size, GLenum *type, GLchar *name)
{
	_glptr_glGetActiveAttrib =
	    (PFN_glGetActiveAttrib)GalogenGetProcAddress("glGetActiveAttrib");
	_glptr_glGetActiveAttrib(
	    program, index, bufSize, length, size, type, name);
}
...
static void GL_APIENTRY
_impl_glVertexAttrib4iv(GLuint index, const GLint *v)
{
	_glptr_glVertexAttrib4iv =
	    (PFN_glVertexAttrib4iv)GalogenGetProcAddress("glVertexAttrib4iv");
	_glptr_glVertexAttrib4iv(index, v);
}
PFN_glVertexAttrib4iv _glptr_glVertexAttrib4iv = _impl_glVertexAttrib4iv;

static void GL_APIENTRY
_impl_glDisableVertexAttribArray(GLuint index)
{
	_glptr_glDisableVertexAttribArray =
	    (PFN_glDisableVertexAttribArray)GalogenGetProcAddress(
		"glDisableVertexAttribArray");
	_glptr_glDisableVertexAttribArray(index);
}
PFN_glDisableVertexAttribArray _glptr_glDisableVertexAttribArray =
    _impl_glDisableVertexAttribArray;

static void GL_APIENTRY
_impl_glDeleteShader(GLuint shader)
{
	_glptr_glDeleteShader =
	    (PFN_glDeleteShader)GalogenGetProcAddress("glDeleteShader");
	_glptr_glDeleteShader(shader);
}
PFN_glDeleteShader _glptr_glDeleteShader = _impl_glDeleteShader;

static void GL_APIENTRY
_impl_glDeleteProgram(GLuint program)
{
	_glptr_glDeleteProgram =
	    (PFN_glDeleteProgram)GalogenGetProcAddress("glDeleteProgram");
	_glptr_glDeleteProgram(program);
}
PFN_glDeleteProgram _glptr_glDeleteProgram = _impl_glDeleteProgram;

static void GL_APIENTRY
_impl_glGetBooleani_v(GLenum target, GLuint index, GLboolean *data)
{
	_glptr_glGetBooleani_v =
	    (PFN_glGetBooleani_v)GalogenGetProcAddress("glGetBooleani_v");
	_glptr_glGetBooleani_v(target, index, data);
}
PFN_glGetBooleani_v _glptr_glGetBooleani_v = _impl_glGetBooleani_v;

static void GL_APIENTRY
_impl_glCompileShader(GLuint shader)
{
	_glptr_glCompileShader =
	    (PFN_glCompileShader)GalogenGetProcAddress("glCompileShader");
	_glptr_glCompileShader(shader);
}
PFN_glCompileShader _glptr_glCompileShader = _impl_glCompileShader;

static void GL_APIENTRY
_impl_glStencilFuncSeparate(GLenum face, GLenum func, GLint ref, GLuint mask)
{
	_glptr_glStencilFuncSeparate =
	    (PFN_glStencilFuncSeparate)GalogenGetProcAddress(
		"glStencilFuncSeparate");
	_glptr_glStencilFuncSeparate(face, func, ref, mask);
}
PFN_glStencilFuncSeparate _glptr_glStencilFuncSeparate =
    _impl_glStencilFuncSeparate;

static void GL_APIENTRY
_impl_glStencilOpSeparate(
...
static void GL_APIENTRY
_impl_glRenderbufferStorageMultisample(GLenum target, GLsizei samples,
    GLenum internalformat, GLsizei width, GLsizei height)
{
	_glptr_glRenderbufferStorageMultisample =
	    (PFN_glRenderbufferStorageMultisample)GalogenGetProcAddress(
		"glRenderbufferStorageMultisample");
	_glptr_glRenderbufferStorageMultisample(
	    target, samples, internalformat, width, height);
}
PFN_glRenderbufferStorageMultisample _glptr_glRenderbufferStorageMultisample =
    _impl_glRenderbufferStorageMultisample;

static void GL_APIENTRY
_impl_glDrawBuffers(GLsizei n, const GLenum *bufs)
{
	_glptr_glDrawBuffers =
	    (PFN_glDrawBuffers)GalogenGetProcAddress("glDrawBuffers");
	_glptr_glDrawBuffers(n, bufs);
}
PFN_glDrawBuffers _glptr_glDrawBuffers = _impl_glDrawBuffers;

static void GL_APIENTRY
_impl_glGetBufferParameteriv(GLenum target, GLenum pname, GLint *params)
{
	_glptr_glGetBufferParameteriv =
	    (PFN_glGetBufferParameteriv)GalogenGetProcAddress(
		"glGetBufferParameteriv");
	_glptr_glGetBufferParameteriv(target, pname, params);
}
PFN_glGetBufferParameteriv _glptr_glGetBufferParameteriv =
    _impl_glGetBufferParameteriv;

static GLboolean GL_APIENTRY
_impl_glUnmapBuffer(GLenum target)
{
	_glptr_glUnmapBuffer =
	    (PFN_glUnmapBuffer)GalogenGetProcAddress("glUnmapBuffer");
	return _glptr_glUnmapBuffer(target);
}
PFN_glUnmapBuffer _glptr_glUnmapBuffer = _impl_glUnmapBuffer;

static void GL_APIENTRY
_impl_glVertexAttrib4dv(GLuint index, const GLdouble *v)
{
	_glptr_glVertexAttrib4dv =
	    (PFN_glVertexAttrib4dv)GalogenGetProcAddress("glVertexAttrib4dv");
	_glptr_glVertexAttrib4dv(index, v);
}
PFN_glVertexAttrib4dv _glptr_glVertexAttrib4dv = _impl_glVertexAttrib4dv;

static void *GL_APIENTRY
_impl_glMapBuffer(GLenum target, GLenum access)
{
	_glptr_glMapBuffer =
	    (PFN_glMapBuffer)GalogenGetProcAddress("glMapBuffer");
	return _glptr_glMapBuffer(target, access);
}
PFN_glMapBuffer _glptr_glMapBuffer = _impl_glMapBuffer;

static void GL_APIENTRY
_impl_glBufferSubData(
    GLenum target, GLintptr offset, GLsizeiptr size, const void *data)
{
	_glptr_glBufferSubData =
	    (PFN_glBufferSubData)GalogenGetProcAddress("glBufferSubData");
	_glptr_glBufferSubData(target, offset, size, data);
}
PFN_glBufferSubData _glptr_glBufferSubData = _impl_glBufferSubData;

static void GL_APIENTRY
_impl_glGetQueryObjectuiv(GLuint id, GLenum pname, GLuint *params)
{
...
static void GL_APIENTRY
_impl_glGetQueryObjectiv(GLuint id, GLenum pname, GLint *params)
{
	_glptr_glGetQueryObjectiv =
	    (PFN_glGetQueryObjectiv)GalogenGetProcAddress("glGetQueryObjectiv");
	_glptr_glGetQueryObjectiv(id, pname, params);
}
PFN_glGetQueryObjectiv _glptr_glGetQueryObjectiv = _impl_glGetQueryObjectiv;

static GLboolean GL_APIENTRY
_impl_glIsQuery(GLuint id)
{
...
static void GL_APIENTRY
_impl_glDeleteQueries(GLsizei n, const GLuint *ids)
{
	_glptr_glDeleteQueries =
	    (PFN_glDeleteQueries)GalogenGetProcAddress("glDeleteQueries");
	_glptr_glDeleteQueries(n, ids);
}
PFN_glDeleteQueries _glptr_glDeleteQueries = _impl_glDeleteQueries;

static void GL_APIENTRY
_impl_glGenQueries(GLsizei n, GLuint *ids)
{
	_glptr_glGenQueries =
	    (PFN_glGenQueries)GalogenGetProcAddress("glGenQueries");
	_glptr_glGenQueries(n, ids);
}
PFN_glGenQueries _glptr_glGenQueries = _impl_glGenQueries;

static void GL_APIENTRY
_impl_glBlendEquation(GLenum mode)
{
	_glptr_glBlendEquation =
	    (PFN_glBlendEquation)GalogenGetProcAddress("glBlendEquation");
	_glptr_glBlendEquation(mode);
}
PFN_glBlendEquation _glptr_glBlendEquation = _impl_glBlendEquation;

static void GL_APIENTRY
_impl_glVertexAttrib3sv(GLuint index, const GLshort *v)
{
	_glptr_glVertexAttrib3sv =
	    (PFN_glVertexAttrib3sv)GalogenGetProcAddress("glVertexAttrib3sv");
	_glptr_glVertexAttrib3sv(index, v);
}
PFN_glVertexAttrib3sv _glptr_glVertexAttrib3sv = _impl_glVertexAttrib3sv;

static void GL_APIENTRY
_impl_glWindowPos3s(GLshort x, GLshort y, GLshort z)
{
	_glptr_glWindowPos3s =
	    (PFN_glWindowPos3s)GalogenGetProcAddress("glWindowPos3s");
	_glptr_glWindowPos3s(x, y, z);
}
PFN_glWindowPos3s _glptr_glWindowPos3s = _impl_glWindowPos3s;

static void GL_APIENTRY
_impl_glWindowPos3iv(const GLint *v)
{
	_glptr_glWindowPos3iv =
	    (PFN_glWindowPos3iv)GalogenGetProcAddress("glWindowPos3iv");
	_glptr_glWindowPos3iv(v);
}
PFN_glWindowPos3iv _glptr_glWindowPos3iv = _impl_glWindowPos3iv;

static void GL_APIENTRY
_impl_glVertexAttribI3ui(GLuint index, GLuint x, GLuint y, GLuint z)
{
	_glptr_glVertexAttribI3ui =
	    (PFN_glVertexAttribI3ui)GalogenGetProcAddress("glVertexAttribI3ui");
	_glptr_glVertexAttribI3ui(index, x, y, z);
}
PFN_glVertexAttribI3ui _glptr_glVertexAttribI3ui = _impl_glVertexAttribI3ui;

static void GL_APIENTRY
_impl_glWindowPos3fv(const GLfloat *v)
{
	_glptr_glWindowPos3fv =
	    (PFN_glWindowPos3fv)GalogenGetProcAddress("glWindowPos3fv");
	_glptr_glWindowPos3fv(v);
}
PFN_glWindowPos3fv _glptr_glWindowPos3fv = _impl_glWindowPos3fv;

static void GL_APIENTRY
_impl_glWindowPos3f(GLfloat x, GLfloat y, GLfloat z)
{
	_glptr_glWindowPos3f =
	    (PFN_glWindowPos3f)GalogenGetProcAddress("glWindowPos3f");
	_glptr_glWindowPos3f(x, y, z);
}
PFN_glWindowPos3f _glptr_glWindowPos3f = _impl_glWindowPos3f;

static void GL_APIENTRY
_impl_glWindowPos3d(GLdouble x, GLdouble y, GLdouble z)
{
	_glptr_glWindowPos3d =
	    (PFN_glWindowPos3d)GalogenGetProcAddress("glWindowPos3d");
	_glptr_glWindowPos3d(x, y, z);
}
PFN_glWindowPos3d _glptr_glWindowPos3d = _impl_glWindowPos3d;

static void GL_APIENTRY
_impl_glGenBuffers(GLsizei n, GLuint *buffers)
{
	_glptr_glGenBuffers =
	    (PFN_glGenBuffers)GalogenGetProcAddress("glGenBuffers");
	_glptr_glGenBuffers(n, buffers);
}
PFN_glGenBuffers _glptr_glGenBuffers = _impl_glGenBuffers;

static void GL_APIENTRY
_impl_glWindowPos2dv(const GLdouble *v)
{
	_glptr_glWindowPos2dv =
	    (PFN_glWindowPos2dv)GalogenGetProcAddress("glWindowPos2dv");
	_glptr_glWindowPos2dv(v);
}
PFN_glWindowPos2dv _glptr_glWindowPos2dv = _impl_glWindowPos2dv;

static void GL_APIENTRY
_impl_glSecondaryColorPointer(
    GLint size, GLenum type, GLsizei stride, const void *pointer)
{
	_glptr_glSecondaryColorPointer =
	    (PFN_glSecondaryColorPointer)GalogenGetProcAddress(
		"glSecondaryColorPointer");
	_glptr_glSecondaryColorPointer(size, type, stride, pointer);
}
PFN_glSecondaryColorPointer _glptr_glSecondaryColorPointer =
    _impl_glSecondaryColorPointer;

static void GL_APIENTRY
_impl_glSecondaryColor3us(GLushort red, GLushort green, GLushort blue)
{
	_glptr_glSecondaryColor3us =
	    (PFN_glSecondaryColor3us)GalogenGetProcAddress(
		"glSecondaryColor3us");
...
static void GL_APIENTRY
_impl_glSecondaryColor3ui(GLuint red, GLuint green, GLuint blue)
{
	_glptr_glSecondaryColor3ui =
	    (PFN_glSecondaryColor3ui)GalogenGetProcAddress(
		"glSecondaryColor3ui");
...
static void GL_APIENTRY
_impl_glSecondaryColor3ub(GLubyte red, GLubyte green, GLubyte blue)
{
	_glptr_glSecondaryColor3ub =
	    (PFN_glSecondaryColor3ub)GalogenGetProcAddress(
		"glSecondaryColor3ub");
	_glptr_glSecondaryColor3ub(red, green, blue);
}
PFN_glSecondaryColor3ub _glptr_glSecondaryColor3ub = _impl_glSecondaryColor3ub;

static GLenum GL_APIENTRY
_impl_glCheckFramebufferStatus(GLenum target)
{
	_glptr_glCheckFramebufferStatus =
	    (PFN_glCheckFramebufferStatus)GalogenGetProcAddress(
		"glCheckFramebufferStatus");
	return _glptr_glCheckFramebufferStatus(target);
}
PFN_glCheckFramebufferStatus _glptr_glCheckFramebufferStatus =
    _impl_glCheckFramebufferStatus;

static void GL_APIENTRY
_impl_glUniform4i(GLint location, GLint v0, GLint v1, GLint v2, GLint v3)
{
	_glptr_glUniform4i =
	    (PFN_glUniform4i)GalogenGetProcAddress("glUniform4i");
	_glptr_glUniform4i(location, v0, v1, v2, v3);
}
PFN_glUniform4i _glptr_glUniform4i = _impl_glUniform4i;

static void GL_APIENTRY
_impl_glSecondaryColor3sv(const GLshort *v)
{
	_glptr_glSecondaryColor3sv =
	    (PFN_glSecondaryColor3sv)GalogenGetProcAddress(
		"glSecondaryColor3sv");
...
static void GL_APIENTRY
_impl_glSecondaryColor3iv(const GLint *v)
{
	_glptr_glSecondaryColor3iv =
	    (PFN_glSecondaryColor3iv)GalogenGetProcAddress(
		"glSecondaryColor3iv");
...
static void GL_APIENTRY
_impl_glSecondaryColor3i(GLint red, GLint green, GLint blue)
{
	_glptr_glSecondaryColor3i =
	    (PFN_glSecondaryColor3i)GalogenGetProcAddress("glSecondaryColor3i");
	_glptr_glSecondaryColor3i(red, green, blue);
}
PFN_glSecondaryColor3i _glptr_glSecondaryColor3i = _impl_glSecondaryColor3i;

static void GL_APIENTRY
_impl_glSecondaryColor3fv(const GLfloat *v)
{
	_glptr_glSecondaryColor3fv =
	    (PFN_glSecondaryColor3fv)GalogenGetProcAddress(
		"glSecondaryColor3fv");
...
static void GL_APIENTRY
_impl_glSecondaryColor3f(GLfloat red, GLfloat green, GLfloat blue)
{
	_glptr_glSecondaryColor3f =
	    (PFN_glSecondaryColor3f)GalogenGetProcAddress("glSecondaryColor3f");
	_glptr_glSecondaryColor3f(red, green, blue);
}
PFN_glSecondaryColor3f _glptr_glSecondaryColor3f = _impl_glSecondaryColor3f;

static void GL_APIENTRY
_impl_glSecondaryColor3dv(const GLdouble *v)
{
	_glptr_glSecondaryColor3dv =
	    (PFN_glSecondaryColor3dv)GalogenGetProcAddress(
		"glSecondaryColor3dv");
...
static void GL_APIENTRY
_impl_glSecondaryColor3d(GLdouble red, GLdouble green, GLdouble blue)
{
	_glptr_glSecondaryColor3d =
	    (PFN_glSecondaryColor3d)GalogenGetProcAddress("glSecondaryColor3d");
	_glptr_glSecondaryColor3d(red, green, blue);
}
PFN_glSecondaryColor3d _glptr_glSecondaryColor3d = _impl_glSecondaryColor3d;

static void GL_APIENTRY
_impl_glSecondaryColor3bv(const GLbyte *v)
{
	_glptr_glSecondaryColor3bv =
	    (PFN_glSecondaryColor3bv)GalogenGetProcAddress(
		"glSecondaryColor3bv");
...
static void GL_APIENTRY
_impl_glSecondaryColor3b(GLbyte red, GLbyte green, GLbyte blue)
{
	_glptr_glSecondaryColor3b =
	    (PFN_glSecondaryColor3b)GalogenGetProcAddress("glSecondaryColor3b");
...
{
	_glptr_glPopAttrib =
	    (PFN_glPopAttrib)GalogenGetProcAddress("glPopAttrib");
	_glptr_glPopAttrib();
}
PFN_glPopAttrib _glptr_glPopAttrib = _impl_glPopAttrib;

static void GL_APIENTRY
_impl_glFogCoorddv(const GLdouble *coord)
{
	_glptr_glFogCoorddv =
	    (PFN_glFogCoorddv)GalogenGetProcAddress("glFogCoorddv");
	_glptr_glFogCoorddv(coord);
}
PFN_glFogCoorddv _glptr_glFogCoorddv = _impl_glFogCoorddv;

static void GL_APIENTRY
_impl_glWindowPos3dv(const GLdouble *v)
{
	_glptr_glWindowPos3dv =
	    (PFN_glWindowPos3dv)GalogenGetProcAddress("glWindowPos3dv");
	_glptr_glWindowPos3dv(v);
}
PFN_glWindowPos3dv _glptr_glWindowPos3dv = _impl_glWindowPos3dv;

static void GL_APIENTRY
_impl_glNormal3s(GLshort nx, GLshort ny, GLshort nz)
{
...
static void GL_APIENTRY
_impl_glVertex3dv(const GLdouble *v)
{
	_glptr_glVertex3dv =
	    (PFN_glVertex3dv)GalogenGetProcAddress("glVertex3dv");
	_glptr_glVertex3dv(v);
}
PFN_glVertex3dv _glptr_glVertex3dv = _impl_glVertex3dv;

static void GL_APIENTRY
_impl_glFogCoordd(GLdouble coord)
{
	_glptr_glFogCoordd =
	    (PFN_glFogCoordd)GalogenGetProcAddress("glFogCoordd");
	_glptr_glFogCoordd(coord);
}
PFN_glFogCoordd _glptr_glFogCoordd = _impl_glFogCoordd;

static void GL_APIENTRY
_impl_glPointParameteriv(GLenum pname, const GLint *params)
{
	_glptr_glPointParameteriv =
	    (PFN_glPointParameteriv)GalogenGetProcAddress("glPointParameteriv");
	_glptr_glPointParameteriv(pname, params);
}
PFN_glPointParameteriv _glptr_glPointParameteriv = _impl_glPointParameteriv;

static void GL_APIENTRY
_impl_glVertexAttrib2s(GLuint index, GLshort x, GLshort y)
{
	_glptr_glVertexAttrib2s =
	    (PFN_glVertexAttrib2s)GalogenGetProcAddress("glVertexAttrib2s");
...
static void GL_APIENTRY
_impl_glPointParameteri(GLenum pname, GLint param)
{
...
static void GL_APIENTRY
_impl_glColor4iv(const GLint *v)
{
...
static void GL_APIENTRY
_impl_glLoadTransposeMatrixf(const GLfloat *m)
{
	_glptr_glLoadTransposeMatrixf =
	    (PFN_glLoadTransposeMatrixf)GalogenGetProcAddress(
		"glLoadTransposeMatrixf");
	_glptr_glLoadTransposeMatrixf(m);
}
PFN_glLoadTransposeMatrixf _glptr_glLoadTransposeMatrixf =
    _impl_glLoadTransposeMatrixf;

static void GL_APIENTRY
_impl_glColor3us(GLushort red, GLushort green, GLushort blue)
{
...
static void GL_APIENTRY
_impl_glFramebufferRenderbuffer(GLenum target, GLenum attachment,
    GLenum renderbuffertarget, GLuint renderbuffer)
{
	_glptr_glFramebufferRenderbuffer =
	    (PFN_glFramebufferRenderbuffer)GalogenGetProcAddress(
		"glFramebufferRenderbuffer");
	_glptr_glFramebufferRenderbuffer(
	    target, attachment, renderbuffertarget, renderbuffer);
}
PFN_glFramebufferRenderbuffer _glptr_glFramebufferRenderbuffer =
    _impl_glFramebufferRenderbuffer;

static void GL_APIENTRY
_impl_glMultiTexCoord4s(
    GLenum target, GLshort s, GLshort t, GLshort r, GLshort q)
{
	_glptr_glMultiTexCoord4s =
	    (PFN_glMultiTexCoord4s)GalogenGetProcAddress("glMultiTexCoord4s");
	_glptr_glMultiTexCoord4s(target, s, t, r, q);
}
PFN_glMultiTexCoord4s _glptr_glMultiTexCoord4s = _impl_glMultiTexCoord4s;

static void GL_APIENTRY
_impl_glGetQueryiv(GLenum target, GLenum pname, GLint *params)
{
	_glptr_glGetQueryiv =
	    (PFN_glGetQueryiv)GalogenGetProcAddress("glGetQueryiv");
	_glptr_glGetQueryiv(target, pname, params);
}
PFN_glGetQueryiv _glptr_glGetQueryiv = _impl_glGetQueryiv;

static void GL_APIENTRY
_impl_glRasterPos2iv(const GLint *v)
{
	_glptr_glRasterPos2iv =
	    (PFN_glRasterPos2iv)GalogenGetProcAddress("glRasterPos2iv");
	_glptr_glRasterPos2iv(v);
}
PFN_glRasterPos2iv _glptr_glRasterPos2iv = _impl_glRasterPos2iv;

static void GL_APIENTRY
_impl_glMultiTexCoord4i(GLenum target, GLint s, GLint t, GLint r, GLint q)
{
	_glptr_glMultiTexCoord4i =
	    (PFN_glMultiTexCoord4i)GalogenGetProcAddress("glMultiTexCoord4i");
	_glptr_glMultiTexCoord4i(target, s, t, r, q);
}
PFN_glMultiTexCoord4i _glptr_glMultiTexCoord4i = _impl_glMultiTexCoord4i;

static void GL_APIENTRY
_impl_glMultiTexCoord3sv(GLenum target, const GLshort *v)
{
	_glptr_glMultiTexCoord3sv =
	    (PFN_glMultiTexCoord3sv)GalogenGetProcAddress("glMultiTexCoord3sv");
	_glptr_glMultiTexCoord3sv(target, v);
}
PFN_glMultiTexCoord3sv _glptr_glMultiTexCoord3sv = _impl_glMultiTexCoord3sv;

static void GL_APIENTRY
_impl_glMultiTexCoord3s(GLenum target, GLshort s, GLshort t, GLshort r)
{
	_glptr_glMultiTexCoord3s =
	    (PFN_glMultiTexCoord3s)GalogenGetProcAddress("glMultiTexCoord3s");
	_glptr_glMultiTexCoord3s(target, s, t, r);
}
PFN_glMultiTexCoord3s _glptr_glMultiTexCoord3s = _impl_glMultiTexCoord3s;

static void GL_APIENTRY
_impl_glRasterPos2dv(const GLdouble *v)
{
	_glptr_glRasterPos2dv =
	    (PFN_glRasterPos2dv)GalogenGetProcAddress("glRasterPos2dv");
	_glptr_glRasterPos2dv(v);
}
PFN_glRasterPos2dv _glptr_glRasterPos2dv = _impl_glRasterPos2dv;

static void GL_APIENTRY
_impl_glMultiTexCoord3iv(GLenum target, const GLint *v)
{
	_glptr_glMultiTexCoord3iv =
	    (PFN_glMultiTexCoord3iv)GalogenGetProcAddress("glMultiTexCoord3iv");
	_glptr_glMultiTexCoord3iv(target, v);
}
PFN_glMultiTexCoord3iv _glptr_glMultiTexCoord3iv = _impl_glMultiTexCoord3iv;

static void GL_APIENTRY
_impl_glGetUniformfv(GLuint program, GLint location, GLfloat *params)
{
	_glptr_glGetUniformfv =
	    (PFN_glGetUniformfv)GalogenGetProcAddress("glGetUniformfv");
	_glptr_glGetUniformfv(program, location, params);
}
PFN_glGetUniformfv _glptr_glGetUniformfv = _impl_glGetUniformfv;

static void GL_APIENTRY
_impl_glMultiTexCoord3i(GLenum target, GLint s, GLint t, GLint r)
{
	_glptr_glMultiTexCoord3i =
	    (PFN_glMultiTexCoord3i)GalogenGetProcAddress("glMultiTexCoord3i");
	_glptr_glMultiTexCoord3i(target, s, t, r);
}
PFN_glMultiTexCoord3i _glptr_glMultiTexCoord3i = _impl_glMultiTexCoord3i;

static void GL_APIENTRY
_impl_glMultiTexCoord3f(GLenum target, GLfloat s, GLfloat t, GLfloat r)
{
	_glptr_glMultiTexCoord3f =
	    (PFN_glMultiTexCoord3f)GalogenGetProcAddress("glMultiTexCoord3f");
	_glptr_glMultiTexCoord3f(target, s, t, r);
}
PFN_glMultiTexCoord3f _glptr_glMultiTexCoord3f = _impl_glMultiTexCoord3f;

static void GL_APIENTRY
_impl_glWindowPos3i(GLint x, GLint y, GLint z)
{
	_glptr_glWindowPos3i =
	    (PFN_glWindowPos3i)GalogenGetProcAddress("glWindowPos3i");
	_glptr_glWindowPos3i(x, y, z);
}
PFN_glWindowPos3i _glptr_glWindowPos3i = _impl_glWindowPos3i;

static void GL_APIENTRY
_impl_glMultiTexCoord3d(GLenum target, GLdouble s, GLdouble t, GLdouble r)
{
	_glptr_glMultiTexCoord3d =
	    (PFN_glMultiTexCoord3d)GalogenGetProcAddress("glMultiTexCoord3d");
	_glptr_glMultiTexCoord3d(target, s, t, r);
}
PFN_glMultiTexCoord3d _glptr_glMultiTexCoord3d = _impl_glMultiTexCoord3d;

static void GL_APIENTRY
_impl_glMultiTexCoord2i(GLenum target, GLint s, GLint t)
{
	_glptr_glMultiTexCoord2i =
	    (PFN_glMultiTexCoord2i)GalogenGetProcAddress("glMultiTexCoord2i");
	_glptr_glMultiTexCoord2i(target, s, t);
}
PFN_glMultiTexCoord2i _glptr_glMultiTexCoord2i = _impl_glMultiTexCoord2i;

static void GL_APIENTRY
_impl_glVertexAttrib4usv(GLuint index, const GLushort *v)
{
	_glptr_glVertexAttrib4usv =
	    (PFN_glVertexAttrib4usv)GalogenGetProcAddress("glVertexAttrib4usv");
	_glptr_glVertexAttrib4usv(index, v);
}
PFN_glVertexAttrib4usv _glptr_glVertexAttrib4usv = _impl_glVertexAttrib4usv;

static void GL_APIENTRY
_impl_glMultiTexCoord1sv(GLenum target, const GLshort *v)
{
	_glptr_glMultiTexCoord1sv =
	    (PFN_glMultiTexCoord1sv)GalogenGetProcAddress("glMultiTexCoord1sv");
	_glptr_glMultiTexCoord1sv(target, v);
}
PFN_glMultiTexCoord1sv _glptr_glMultiTexCoord1sv = _impl_glMultiTexCoord1sv;

static void GL_APIENTRY
_impl_glScaled(GLdouble x, GLdouble y, GLdouble z)
{
...
static void GL_APIENTRY
_impl_glMultiTexCoord1i(GLenum target, GLint s)
{
	_glptr_glMultiTexCoord1i =
	    (PFN_glMultiTexCoord1i)GalogenGetProcAddress("glMultiTexCoord1i");
	_glptr_glMultiTexCoord1i(target, s);
}
PFN_glMultiTexCoord1i _glptr_glMultiTexCoord1i = _impl_glMultiTexCoord1i;

static void GL_APIENTRY
_impl_glWindowPos2sv(const GLshort *v)
{
	_glptr_glWindowPos2sv =
	    (PFN_glWindowPos2sv)GalogenGetProcAddress("glWindowPos2sv");
	_glptr_glWindowPos2sv(v);
}
PFN_glWindowPos2sv _glptr_glWindowPos2sv = _impl_glWindowPos2sv;

static void GL_APIENTRY
_impl_glMultiTexCoord1f(GLenum target, GLfloat s)
{
	_glptr_glMultiTexCoord1f =
	    (PFN_glMultiTexCoord1f)GalogenGetProcAddress("glMultiTexCoord1f");
	_glptr_glMultiTexCoord1f(target, s);
}
PFN_glMultiTexCoord1f _glptr_glMultiTexCoord1f = _impl_glMultiTexCoord1f;

static void GL_APIENTRY
_impl_glMultiTexCoord1dv(GLenum target, const GLdouble *v)
{
	_glptr_glMultiTexCoord1dv =
	    (PFN_glMultiTexCoord1dv)GalogenGetProcAddress("glMultiTexCoord1dv");
	_glptr_glMultiTexCoord1dv(target, v);
}
PFN_glMultiTexCoord1dv _glptr_glMultiTexCoord1dv = _impl_glMultiTexCoord1dv;

static void GL_APIENTRY
_impl_glGetCompressedTexImage(GLenum target, GLint level, void *img)
{
	_glptr_glGetCompressedTexImage =
	    (PFN_glGetCompressedTexImage)GalogenGetProcAddress(
		"glGetCompressedTexImage");
	_glptr_glGetCompressedTexImage(target, level, img);
}
PFN_glGetCompressedTexImage _glptr_glGetCompressedTexImage =
    _impl_glGetCompressedTexImage;

static void GL_APIENTRY
_impl_glColor3b(GLbyte red, GLbyte green, GLbyte blue)
{
...
static void GL_APIENTRY
_impl_glFrustum(GLdouble left, GLdouble right, GLdouble bottom, GLdouble top,
...
static void GL_APIENTRY
_impl_glCompressedTexSubImage2D(GLenum target, GLint level, GLint xoffset,
    GLint yoffset, GLsizei width, GLsizei height, GLenum format,
    GLsizei imageSize, const void *data)
{
	_glptr_glCompressedTexSubImage2D =
	    (PFN_glCompressedTexSubImage2D)GalogenGetProcAddress(
		"glCompressedTexSubImage2D");
	_glptr_glCompressedTexSubImage2D(target, level, xoffset, yoffset, width,
...
static void GL_APIENTRY
_impl_glUniform4ui(GLint location, GLuint v0, GLuint v1, GLuint v2, GLuint v3)
{
	_glptr_glUniform4ui =
	    (PFN_glUniform4ui)GalogenGetProcAddress("glUniform4ui");
	_glptr_glUniform4ui(location, v0, v1, v2, v3);
}
PFN_glUniform4ui _glptr_glUniform4ui = _impl_glUniform4ui;

static void GL_APIENTRY
_impl_glVertexAttribI4usv(GLuint index, const GLushort *v)
{
	_glptr_glVertexAttribI4usv =
	    (PFN_glVertexAttribI4usv)GalogenGetProcAddress(
		"glVertexAttribI4usv");
...
static void GL_APIENTRY
_impl_glCompressedTexImage2D(GLenum target, GLint level, GLenum internalformat,
    GLsizei width, GLsizei height, GLint border, GLsizei imageSize,
    const void *data)
{
	_glptr_glCompressedTexImage2D =
	    (PFN_glCompressedTexImage2D)GalogenGetProcAddress(
		"glCompressedTexImage2D");
	_glptr_glCompressedTexImage2D(target, level, internalformat, width,
	    height, border, imageSize, data);
}
PFN_glCompressedTexImage2D _glptr_glCompressedTexImage2D =
    _impl_glCompressedTexImage2D;

static void GL_APIENTRY
_impl_glCompressedTexImage3D(GLenum target, GLint level, GLenum internalformat,
    GLsizei width, GLsizei height, GLsizei depth, GLint border,
    GLsizei imageSize, const void *data)
{
	_glptr_glCompressedTexImage3D =
	    (PFN_glCompressedTexImage3D)GalogenGetProcAddress(
		"glCompressedTexImage3D");
	_glptr_glCompressedTexImage3D(target, level, internalformat, width,
	    height, depth, border, imageSize, data);
}
PFN_glCompressedTexImage3D _glptr_glCompressedTexImage3D =
    _impl_glCompressedTexImage3D;

static void GL_APIENTRY
_impl_glListBase(GLuint base)
{
...
static void GL_APIENTRY
_impl_glSecondaryColor3uiv(const GLuint *v)
{
	_glptr_glSecondaryColor3uiv =
	    (PFN_glSecondaryColor3uiv)GalogenGetProcAddress(
		"glSecondaryColor3uiv");
	_glptr_glSecondaryColor3uiv(v);
}
PFN_glSecondaryColor3uiv _glptr_glSecondaryColor3uiv =
    _impl_glSecondaryColor3uiv;

static void GL_APIENTRY
_impl_glCompressedTexImage1D(GLenum target, GLint level, GLenum internalformat,
    GLsizei width, GLint border, GLsizei imageSize, const void *data)
{
	_glptr_glCompressedTexImage1D =
	    (PFN_glCompressedTexImage1D)GalogenGetProcAddress(
		"glCompressedTexImage1D");
	_glptr_glCompressedTexImage1D(
	    target, level, internalformat, width, border, imageSize, data);
}
PFN_glCompressedTexImage1D _glptr_glCompressedTexImage1D =
    _impl_glCompressedTexImage1D;

static void GL_APIENTRY
_impl_glTexSubImage3D(GLenum target, GLint level, GLint xoffset, GLint yoffset,
    GLint zoffset, GLsizei width, GLsizei height, GLsizei depth, GLenum format,
    GLenum type, const void *pixels)
{
	_glptr_glTexSubImage3D =
	    (PFN_glTexSubImage3D)GalogenGetProcAddress("glTexSubImage3D");
	_glptr_glTexSubImage3D(target, level, xoffset, yoffset, zoffset, width,
	    height, depth, format, type, pixels);
}
PFN_glTexSubImage3D _glptr_glTexSubImage3D = _impl_glTexSubImage3D;

static void GL_APIENTRY
_impl_glUniformMatrix4fv(
    GLint location, GLsizei count, GLboolean transpose, const GLfloat *value)
{
	_glptr_glUniformMatrix4fv =
	    (PFN_glUniformMatrix4fv)GalogenGetProcAddress("glUniformMatrix4fv");
...
static void GL_APIENTRY
_impl_glPushClientAttrib(GLbitfield mask)
{
	_glptr_glPushClientAttrib =
	    (PFN_glPushClientAttrib)GalogenGetProcAddress("glPushClientAttrib");
	_glptr_glPushClientAttrib(mask);
}
PFN_glPushClientAttrib _glptr_glPushClientAttrib = _impl_glPushClientAttrib;

static void GL_APIENTRY
_impl_glPrioritizeTextures(
    GLsizei n, const GLuint *textures, const GLfloat *priorities)
{
	_glptr_glPrioritizeTextures =
	    (PFN_glPrioritizeTextures)GalogenGetProcAddress(
		"glPrioritizeTextures");
	_glptr_glPrioritizeTextures(n, textures, priorities);
}
PFN_glPrioritizeTextures _glptr_glPrioritizeTextures =
    _impl_glPrioritizeTextures;

static const GLubyte *GL_APIENTRY
_impl_glGetString(GLenum name)
{
	_glptr_glGetString =
	    (PFN_glGetString)GalogenGetProcAddress("glGetString");
	return _glptr_glGetString(name);
}
PFN_glGetString _glptr_glGetString = _impl_glGetString;

static void GL_APIENTRY
_impl_glEnableClientState(GLenum array)
{
	_glptr_glEnableClientState =
	    (PFN_glEnableClientState)GalogenGetProcAddress(
		"glEnableClientState");
...
static void GL_APIENTRY
_impl_glDisableClientState(GLenum array)
{
	_glptr_glDisableClientState =
	    (PFN_glDisableClientState)GalogenGetProcAddress(
		"glDisableClientState");
	_glptr_glDisableClientState(array);
}
PFN_glDisableClientState _glptr_glDisableClientState =
    _impl_glDisableClientState;

static void GL_APIENTRY
_impl_glTexCoord4dv(const GLdouble *v)
{
	_glptr_glTexCoord4dv =
	    (PFN_glTexCoord4dv)GalogenGetProcAddress("glTexCoord4dv");
	_glptr_glTexCoord4dv(v);
}
PFN_glTexCoord4dv _glptr_glTexCoord4dv = _impl_glTexCoord4dv;

static void GL_APIENTRY
_impl_glMultiTexCoord4iv(GLenum target, const GLint *v)
{
	_glptr_glMultiTexCoord4iv =
	    (PFN_glMultiTexCoord4iv)GalogenGetProcAddress("glMultiTexCoord4iv");
	_glptr_glMultiTexCoord4iv(target, v);
}
PFN_glMultiTexCoord4iv _glptr_glMultiTexCoord4iv = _impl_glMultiTexCoord4iv;

static void GL_APIENTRY
_impl_glRenderbufferStorage(
    GLenum target, GLenum internalformat, GLsizei width, GLsizei height)
{
	_glptr_glRenderbufferStorage =
	    (PFN_glRenderbufferStorage)GalogenGetProcAddress(
		"glRenderbufferStorage");
	_glptr_glRenderbufferStorage(target, internalformat, width, height);
}
PFN_glRenderbufferStorage _glptr_glRenderbufferStorage =
    _impl_glRenderbufferStorage;

static void GL_APIENTRY
_impl_glColorPointer(
    GLint size, GLenum type, GLsizei stride, const void *pointer)
{
	_glptr_glColorPointer =
	    (PFN_glColorPointer)GalogenGetProcAddress("glColorPointer");
	_glptr_glColorPointer(size, type, stride, pointer);
}
PFN_glColorPointer _glptr_glColorPointer = _impl_glColorPointer;

static void GL_APIENTRY
_impl_glArrayElement(GLint i)
{
	_glptr_glArrayElement =
	    (PFN_glArrayElement)GalogenGetProcAddress("glArrayElement");
	_glptr_glArrayElement(i);
}
PFN_glArrayElement _glptr_glArrayElement = _impl_glArrayElement;

static void GL_APIENTRY
_impl_glTexCoord1i(GLint s)
{
	_glptr_glTexCoord1i =
	    (PFN_glTexCoord1i)GalogenGetProcAddress("glTexCoord1i");
	_glptr_glTexCoord1i(s);
}
PFN_glTexCoord1i _glptr_glTexCoord1i = _impl_glTexCoord1i;

static GLboolean GL_APIENTRY
_impl_glIsTexture(GLuint texture)
{
	_glptr_glIsTexture =
	    (PFN_glIsTexture)GalogenGetProcAddress("glIsTexture");
	return _glptr_glIsTexture(texture);
}
PFN_glIsTexture _glptr_glIsTexture = _impl_glIsTexture;

static void GL_APIENTRY
_impl_glBegin(GLenum mode)
{
...
static void GL_APIENTRY
_impl_glGenTextures(GLsizei n, GLuint *textures)
{
	_glptr_glGenTextures =
	    (PFN_glGenTextures)GalogenGetProcAddress("glGenTextures");
	_glptr_glGenTextures(n, textures);
}
PFN_glGenTextures _glptr_glGenTextures = _impl_glGenTextures;

static void GL_APIENTRY
_impl_glColor4f(GLfloat red, GLfloat green, GLfloat blue, GLfloat alpha)
{
...
static void GL_APIENTRY
_impl_glTexSubImage1D(GLenum target, GLint level, GLint xoffset, GLsizei width,
    GLenum format, GLenum type, const void *pixels)
{
	_glptr_glTexSubImage1D =
	    (PFN_glTexSubImage1D)GalogenGetProcAddress("glTexSubImage1D");
	_glptr_glTexSubImage1D(
...
static void GL_APIENTRY
_impl_glCopyTexSubImage2D(GLenum target, GLint level, GLint xoffset,
    GLint yoffset, GLint x, GLint y, GLsizei width, GLsizei height)
{
	_glptr_glCopyTexSubImage2D =
	    (PFN_glCopyTexSubImage2D)GalogenGetProcAddress(
		"glCopyTexSubImage2D");
	_glptr_glCopyTexSubImage2D(
...
static void GL_APIENTRY
_impl_glMultiTexCoord2f(GLenum target, GLfloat s, GLfloat t)
{
	_glptr_glMultiTexCoord2f =
	    (PFN_glMultiTexCoord2f)GalogenGetProcAddress("glMultiTexCoord2f");
	_glptr_glMultiTexCoord2f(target, s, t);
}
PFN_glMultiTexCoord2f _glptr_glMultiTexCoord2f = _impl_glMultiTexCoord2f;

static void GL_APIENTRY
_impl_glCopyTexImage1D(GLenum target, GLint level, GLenum internalformat,
    GLint x, GLint y, GLsizei width, GLint border)
{
	_glptr_glCopyTexImage1D =
	    (PFN_glCopyTexImage1D)GalogenGetProcAddress("glCopyTexImage1D");
	_glptr_glCopyTexImage1D(
...
static void GL_APIENTRY
_impl_glPolygonOffset(GLfloat factor, GLfloat units)
{
	_glptr_glPolygonOffset =
	    (PFN_glPolygonOffset)GalogenGetProcAddress("glPolygonOffset");
	_glptr_glPolygonOffset(factor, units);
}
PFN_glPolygonOffset _glptr_glPolygonOffset = _impl_glPolygonOffset;

static void GL_APIENTRY
_impl_glNormal3dv(const GLdouble *v)
{
	_glptr_glNormal3dv =
	    (PFN_glNormal3dv)GalogenGetProcAddress("glNormal3dv");
	_glptr_glNormal3dv(v);
}
PFN_glNormal3dv _glptr_glNormal3dv = _impl_glNormal3dv;

static void GL_APIENTRY
_impl_glNormalPointer(GLenum type, GLsizei stride, const void *pointer)
{
	_glptr_glNormalPointer =
	    (PFN_glNormalPointer)GalogenGetProcAddress("glNormalPointer");
	_glptr_glNormalPointer(type, stride, pointer);
}
PFN_glNormalPointer _glptr_glNormalPointer = _impl_glNormalPointer;

static void GL_APIENTRY
_impl_glGetPointerv(GLenum pname, void **params)
{
	_glptr_glGetPointerv =
	    (PFN_glGetPointerv)GalogenGetProcAddress("glGetPointerv");
	_glptr_glGetPointerv(pname, params);
}
PFN_glGetPointerv _glptr_glGetPointerv = _impl_glGetPointerv;

static void GL_APIENTRY
_impl_glDrawElements(
    GLenum mode, GLsizei count, GLenum type, const void *indices)
{
	_glptr_glDrawElements =
	    (PFN_glDrawElements)GalogenGetProcAddress("glDrawElements");
	_glptr_glDrawElements(mode, count, type, indices);
}
PFN_glDrawElements _glptr_glDrawElements = _impl_glDrawElements;

static void GL_APIENTRY
_impl_glEndConditionalRender()
{
	_glptr_glEndConditionalRender =
	    (PFN_glEndConditionalRender)GalogenGetProcAddress(
		"glEndConditionalRender");
	_glptr_glEndConditionalRender();
}
PFN_glEndConditionalRender _glptr_glEndConditionalRender =
    _impl_glEndConditionalRender;

static void GL_APIENTRY
_impl_glGetTransformFeedbackVarying(GLuint program, GLuint index,
...
PFN_glGetTransformFeedbackVarying _glptr_glGetTransformFeedbackVarying =
    _impl_glGetTransformFeedbackVarying;

static void GL_APIENTRY
_impl_glPushName(GLuint name)
{
...
static void GL_APIENTRY
_impl_glMultiTexCoord2iv(GLenum target, const GLint *v)
{
	_glptr_glMultiTexCoord2iv =
	    (PFN_glMultiTexCoord2iv)GalogenGetProcAddress("glMultiTexCoord2iv");
	_glptr_glMultiTexCoord2iv(target, v);
}
PFN_glMultiTexCoord2iv _glptr_glMultiTexCoord2iv = _impl_glMultiTexCoord2iv;

static void GL_APIENTRY
_impl_glRotated(GLdouble angle, GLdouble x, GLdouble y, GLdouble z)
{
...
static void GL_APIENTRY
_impl_glTexParameteriv(GLenum target, GLenum pname, const GLint *params)
{
	_glptr_glTexParameteriv =
	    (PFN_glTexParameteriv)GalogenGetProcAddress("glTexParameteriv");
	_glptr_glTexParameteriv(target, pname, params);
}
PFN_glTexParameteriv _glptr_glTexParameteriv = _impl_glTexParameteriv;

static void GL_APIENTRY
_impl_glGetMapiv(GLenum target, GLenum query, GLint *v)
{
...
{
	_glptr_glPushMatrix =
	    (PFN_glPushMatrix)GalogenGetProcAddress("glPushMatrix");
	_glptr_glPushMatrix();
}
PFN_glPushMatrix _glptr_glPushMatrix = _impl_glPushMatrix;

static void GL_APIENTRY
_impl_glTexCoordPointer(
    GLint size, GLenum type, GLsizei stride, const void *pointer)
{
	_glptr_glTexCoordPointer =
	    (PFN_glTexCoordPointer)GalogenGetProcAddress("glTexCoordPointer");
	_glptr_glTexCoordPointer(size, type, stride, pointer);
}
PFN_glTexCoordPointer _glptr_glTexCoordPointer = _impl_glTexCoordPointer;

static void GL_APIENTRY
_impl_glDeleteFramebuffers(GLsizei n, const GLuint *framebuffers)
{
	_glptr_glDeleteFramebuffers =
	    (PFN_glDeleteFramebuffers)GalogenGetProcAddress(
		"glDeleteFramebuffers");
	_glptr_glDeleteFramebuffers(n, framebuffers);
}
PFN_glDeleteFramebuffers _glptr_glDeleteFramebuffers =
    _impl_glDeleteFramebuffers;

static void GL_APIENTRY
_impl_glPopMatrix()
{
	_glptr_glPopMatrix =
	    (PFN_glPopMatrix)GalogenGetProcAddress("glPopMatrix");
	_glptr_glPopMatrix();
}
PFN_glPopMatrix _glptr_glPopMatrix = _impl_glPopMatrix;

static void GL_APIENTRY
_impl_glBlendEquationSeparate(GLenum modeRGB, GLenum modeAlpha)
{
	_glptr_glBlendEquationSeparate =
	    (PFN_glBlendEquationSeparate)GalogenGetProcAddress(
		"glBlendEquationSeparate");
	_glptr_glBlendEquationSeparate(modeRGB, modeAlpha);
}
PFN_glBlendEquationSeparate _glptr_glBlendEquationSeparate =
    _impl_glBlendEquationSeparate;

static void GL_APIENTRY
_impl_glMultMatrixf(const GLfloat *m)
{
	_glptr_glMultMatrixf =
	    (PFN_glMultMatrixf)GalogenGetProcAddress("glMultMatrixf");
	_glptr_glMultMatrixf(m);
}
PFN_glMultMatrixf _glptr_glMultMatrixf = _impl_glMultMatrixf;

static void GL_APIENTRY
_impl_glDeleteTextures(GLsizei n, const GLuint *textures)
{
	_glptr_glDeleteTextures =
	    (PFN_glDeleteTextures)GalogenGetProcAddress("glDeleteTextures");
	_glptr_glDeleteTextures(n, textures);
}
PFN_glDeleteTextures _glptr_glDeleteTextures = _impl_glDeleteTextures;

static void GL_APIENTRY
_impl_glLoadTransposeMatrixd(const GLdouble *m)
{
	_glptr_glLoadTransposeMatrixd =
	    (PFN_glLoadTransposeMatrixd)GalogenGetProcAddress(
		"glLoadTransposeMatrixd");
	_glptr_glLoadTransposeMatrixd(m);
}
PFN_glLoadTransposeMatrixd _glptr_glLoadTransposeMatrixd =
    _impl_glLoadTransposeMatrixd;

static void GL_APIENTRY
_impl_glGetProgramiv(GLuint program, GLenum pname, GLint *params)
{
	_glptr_glGetProgramiv =
	    (PFN_glGetProgramiv)GalogenGetProcAddress("glGetProgramiv");
	_glptr_glGetProgramiv(program, pname, params);
}
PFN_glGetProgramiv _glptr_glGetProgramiv = _impl_glGetProgramiv;

static void GL_APIENTRY
_impl_glMaterialiv(GLenum face, GLenum pname, const GLint *params)
{
	_glptr_glMaterialiv =
	    (PFN_glMaterialiv)GalogenGetProcAddress("glMaterialiv");
	_glptr_glMaterialiv(face, pname, params);
}
PFN_glMaterialiv _glptr_glMaterialiv = _impl_glMaterialiv;

static void GL_APIENTRY
_impl_glMultiTexCoord2d(GLenum target, GLdouble s, GLdouble t)
{
	_glptr_glMultiTexCoord2d =
	    (PFN_glMultiTexCoord2d)GalogenGetProcAddress("glMultiTexCoord2d");
	_glptr_glMultiTexCoord2d(target, s, t);
}
PFN_glMultiTexCoord2d _glptr_glMultiTexCoord2d = _impl_glMultiTexCoord2d;

static void GL_APIENTRY
_impl_glGetTexGenfv(GLenum coord, GLenum pname, GLfloat *params)
{
	_glptr_glGetTexGenfv =
	    (PFN_glGetTexGenfv)GalogenGetProcAddress("glGetTexGenfv");
	_glptr_glGetTexGenfv(coord, pname, params);
}
PFN_glGetTexGenfv _glptr_glGetTexGenfv = _impl_glGetTexGenfv;

static void GL_APIENTRY
_impl_glUniform1uiv(GLint location, GLsizei count, const GLuint *value)
{
	_glptr_glUniform1uiv =
	    (PFN_glUniform1uiv)GalogenGetProcAddress("glUniform1uiv");
	_glptr_glUniform1uiv(location, count, value);
}
PFN_glUniform1uiv _glptr_glUniform1uiv = _impl_glUniform1uiv;

static void GL_APIENTRY
_impl_glCopyTexImage2D(GLenum target, GLint level, GLenum internalformat,
    GLint x, GLint y, GLsizei width, GLsizei height, GLint border)
{
	_glptr_glCopyTexImage2D =
	    (PFN_glCopyTexImage2D)GalogenGetProcAddress("glCopyTexImage2D");
	_glptr_glCopyTexImage2D(
    ...
    GLenum target, GLint level, GLenum pname, GLfloat *params)
{
	_glptr_glGetTexLevelParameterfv =
	    (PFN_glGetTexLevelParameterfv)GalogenGetProcAddress(
		"glGetTexLevelParameterfv");
	_glptr_glGetTexLevelParameterfv(target, level, pname, params);
}
PFN_glGetTexLevelParameterfv _glptr_glGetTexLevelParameterfv =
    _impl_glGetTexLevelParameterfv;

static void GL_APIENTRY
_impl_glGetPixelMapusv(GLenum map, GLushort *values)
{
	_glptr_glGetPixelMapusv =
	    (PFN_glGetPixelMapusv)GalogenGetProcAddress("glGetPixelMapusv");
	_glptr_glGetPixelMapusv(map, values);
}
PFN_glGetPixelMapusv _glptr_glGetPixelMapusv = _impl_glGetPixelMapusv;

static void GL_APIENTRY
_impl_glPixelMapuiv(GLenum map, GLsizei mapsize, const GLuint *values)
{
	_glptr_glPixelMapuiv =
	    (PFN_glPixelMapuiv)GalogenGetProcAddress("glPixelMapuiv");
	_glptr_glPixelMapuiv(map, mapsize, values);
}
PFN_glPixelMapuiv _glptr_glPixelMapuiv = _impl_glPixelMapuiv;

static void GL_APIENTRY
_impl_glBindTexture(GLenum target, GLuint texture)
{
	_glptr_glBindTexture =
	    (PFN_glBindTexture)GalogenGetProcAddress("glBindTexture");
	_glptr_glBindTexture(target, texture);
}
PFN_glBindTexture _glptr_glBindTexture = _impl_glBindTexture;

static void GL_APIENTRY
_impl_glGetPixelMapuiv(GLenum map, GLuint *values)
{
	_glptr_glGetPixelMapuiv =
	    (PFN_glGetPixelMapuiv)GalogenGetProcAddress("glGetPixelMapuiv");
	_glptr_glGetPixelMapuiv(map, values);
}
PFN_glGetPixelMapuiv _glptr_glGetPixelMapuiv = _impl_glGetPixelMapuiv;

static void GL_APIENTRY
_impl_glGetMaterialiv(GLenum face, GLenum pname, GLint *params)
{
	_glptr_glGetMaterialiv =
	    (PFN_glGetMaterialiv)GalogenGetProcAddress("glGetMaterialiv");
	_glptr_glGetMaterialiv(face, pname, params);
}
PFN_glGetMaterialiv _glptr_glGetMaterialiv = _impl_glGetMaterialiv;

static void GL_APIENTRY
_impl_glGetUniformuiv(GLuint program, GLint location, GLuint *params)
{
	_glptr_glGetUniformuiv =
	    (PFN_glGetUniformuiv)GalogenGetProcAddress("glGetUniformuiv");
	_glptr_glGetUniformuiv(program, location, params);
}
PFN_glGetUniformuiv _glptr_glGetUniformuiv = _impl_glGetUniformuiv;

static void GL_APIENTRY
_impl_glGetMapfv(GLenum target, GLenum query, GLfloat *v)
{
...
static void GL_APIENTRY
_impl_glGetMapdv(GLenum target, GLenum query, GLdouble *v)
{
...
static void GL_APIENTRY
_impl_glMultiTexCoord4f(
    GLenum target, GLfloat s, GLfloat t, GLfloat r, GLfloat q)
{
	_glptr_glMultiTexCoord4f =
	    (PFN_glMultiTexCoord4f)GalogenGetProcAddress("glMultiTexCoord4f");
	_glptr_glMultiTexCoord4f(target, s, t, r, q);
}
PFN_glMultiTexCoord4f _glptr_glMultiTexCoord4f = _impl_glMultiTexCoord4f;

static void GL_APIENTRY
_impl_glGetLightiv(GLenum light, GLenum pname, GLint *params)
{
	_glptr_glGetLightiv =
	    (PFN_glGetLightiv)GalogenGetProcAddress("glGetLightiv");
	_glptr_glGetLightiv(light, pname, params);
}
PFN_glGetLightiv _glptr_glGetLightiv = _impl_glGetLightiv;

static void GL_APIENTRY
_impl_glGetLightfv(GLenum light, GLenum pname, GLfloat *params)
{
	_glptr_glGetLightfv =
	    (PFN_glGetLightfv)GalogenGetProcAddress("glGetLightfv");
	_glptr_glGetLightfv(light, pname, params);
}
PFN_glGetLightfv _glptr_glGetLightfv = _impl_glGetLightfv;

static void GL_APIENTRY
_impl_glVertexAttrib4Nbv(GLuint index, const GLbyte *v)
{
	_glptr_glVertexAttrib4Nbv =
	    (PFN_glVertexAttrib4Nbv)GalogenGetProcAddress("glVertexAttrib4Nbv");
	_glptr_glVertexAttrib4Nbv(index, v);
}
PFN_glVertexAttrib4Nbv _glptr_glVertexAttrib4Nbv = _impl_glVertexAttrib4Nbv;

static void GL_APIENTRY
_impl_glDrawPixels(GLsizei width, GLsizei height, GLenum format, GLenum type,
    const void *pixels)
{
	_glptr_glDrawPixels =
	    (PFN_glDrawPixels)GalogenGetProcAddress("glDrawPixels");
	_glptr_glDrawPixels(width, height, format, type, pixels);
}
PFN_glDrawPixels _glptr_glDrawPixels = _impl_glDrawPixels;

static void GL_APIENTRY
_impl_glPixelMapusv(GLenum map, GLsizei mapsize, const GLushort *values)
{
	_glptr_glPixelMapusv =
	    (PFN_glPixelMapusv)GalogenGetProcAddress("glPixelMapusv");
	_glptr_glPixelMapusv(map, mapsize, values);
}
PFN_glPixelMapusv _glptr_glPixelMapusv = _impl_glPixelMapusv;

static void GL_APIENTRY
_impl_glPixelTransferi(GLenum pname, GLint param)
{
	_glptr_glPixelTransferi =
	    (PFN_glPixelTransferi)GalogenGetProcAddress("glPixelTransferi");
	_glptr_glPixelTransferi(pname, param);
}
PFN_glPixelTransferi _glptr_glPixelTransferi = _impl_glPixelTransferi;

static void GL_APIENTRY
_impl_glTexImage3D(GLenum target, GLint level, GLint internalformat,
    GLsizei width, GLsizei height, GLsizei depth, GLint border, GLenum format,
    GLenum type, const void *pixels)
{
	_glptr_glTexImage3D =
	    (PFN_glTexImage3D)GalogenGetProcAddress("glTexImage3D");
	_glptr_glTexImage3D(target, level, internalformat, width, height, depth,
	    border, format, type, pixels);
}
PFN_glTexImage3D _glptr_glTexImage3D = _impl_glTexImage3D;

static void GL_APIENTRY
_impl_glVertexAttrib4f(GLuint index, GLfloat x, GLfloat y, GLfloat z, GLfloat w)
{
	_glptr_glVertexAttrib4f =
	    (PFN_glVertexAttrib4f)GalogenGetProcAddress("glVertexAttrib4f");
	_glptr_glVertexAttrib4f(index, x, y, z, w);
}
PFN_glVertexAttrib4f _glptr_glVertexAttrib4f = _impl_glVertexAttrib4f;

static void GL_APIENTRY
_impl_glPixelTransferf(GLenum pname, GLfloat param)
{
	_glptr_glPixelTransferf =
	    (PFN_glPixelTransferf)GalogenGetProcAddress("glPixelTransferf");
	_glptr_glPixelTransferf(pname, param);
}
PFN_glPixelTransferf _glptr_glPixelTransferf = _impl_glPixelTransferf;

static void GL_APIENTRY
_impl_glClearIndex(GLfloat c)
{
	_glptr_glClearIndex =
	    (PFN_glClearIndex)GalogenGetProcAddress("glClearIndex");
	_glptr_glClearIndex(c);
}
PFN_glClearIndex _glptr_glClearIndex = _impl_glClearIndex;

static void GL_APIENTRY
_impl_glEvalPoint2(GLint i, GLint j)
{
	_glptr_glEvalPoint2 =
	    (PFN_glEvalPoint2)GalogenGetProcAddress("glEvalPoint2");
	_glptr_glEvalPoint2(i, j);
}
PFN_glEvalPoint2 _glptr_glEvalPoint2 = _impl_glEvalPoint2;

static void GL_APIENTRY
_impl_glRotatef(GLfloat angle, GLfloat x, GLfloat y, GLfloat z)
{
...
static void GL_APIENTRY
_impl_glEvalPoint1(GLint i)
{
	_glptr_glEvalPoint1 =
	    (PFN_glEvalPoint1)GalogenGetProcAddress("glEvalPoint1");
	_glptr_glEvalPoint1(i);
}
PFN_glEvalPoint1 _glptr_glEvalPoint1 = _impl_glEvalPoint1;

static void GL_APIENTRY
_impl_glUniform2ui(GLint location, GLuint v0, GLuint v1)
{
	_glptr_glUniform2ui =
	    (PFN_glUniform2ui)GalogenGetProcAddress("glUniform2ui");
    ...
    GLenum target, GLint level, GLenum format, GLenum type, void *pixels)
{
	_glptr_glGetTexImage =
	    (PFN_glGetTexImage)GalogenGetProcAddress("glGetTexImage");
	_glptr_glGetTexImage(target, level, format, type, pixels);
}
PFN_glGetTexImage _glptr_glGetTexImage = _impl_glGetTexImage;

static void GL_APIENTRY
_impl_glEvalMesh1(GLenum mode, GLint i1, GLint i2)
{
	_glptr_glEvalMesh1 =
	    (PFN_glEvalMesh1)GalogenGetProcAddress("glEvalMesh1");
	_glptr_glEvalMesh1(mode, i1, i2);
}
PFN_glEvalMesh1 _glptr_glEvalMesh1 = _impl_glEvalMesh1;

static void GL_APIENTRY
_impl_glGetTexParameterIuiv(GLenum target, GLenum pname, GLuint *params)
{
	_glptr_glGetTexParameterIuiv =
	    (PFN_glGetTexParameterIuiv)GalogenGetProcAddress(
		"glGetTexParameterIuiv");
	_glptr_glGetTexParameterIuiv(target, pname, params);
}
PFN_glGetTexParameterIuiv _glptr_glGetTexParameterIuiv =
    _impl_glGetTexParameterIuiv;

static void GL_APIENTRY
_impl_glVertex3iv(const GLint *v)
{
	_glptr_glVertex3iv =
	    (PFN_glVertex3iv)GalogenGetProcAddress("glVertex3iv");
	_glptr_glVertex3iv(v);
}
PFN_glVertex3iv _glptr_glVertex3iv = _impl_glVertex3iv;

static void GL_APIENTRY
_impl_glEvalCoord2fv(const GLfloat *u)
{
	_glptr_glEvalCoord2fv =
	    (PFN_glEvalCoord2fv)GalogenGetProcAddress("glEvalCoord2fv");
	_glptr_glEvalCoord2fv(u);
}
PFN_glEvalCoord2fv _glptr_glEvalCoord2fv = _impl_glEvalCoord2fv;

static void GL_APIENTRY
_impl_glEvalCoord2dv(const GLdouble *u)
{
	_glptr_glEvalCoord2dv =
	    (PFN_glEvalCoord2dv)GalogenGetProcAddress("glEvalCoord2dv");
	_glptr_glEvalCoord2dv(u);
}
PFN_glEvalCoord2dv _glptr_glEvalCoord2dv = _impl_glEvalCoord2dv;

static void GL_APIENTRY
_impl_glTranslatef(GLfloat x, GLfloat y, GLfloat z)
{
	_glptr_glTranslatef =
	    (PFN_glTranslatef)GalogenGetProcAddress("glTranslatef");
	_glptr_glTranslatef(x, y, z);
}
PFN_glTranslatef _glptr_glTranslatef = _impl_glTranslatef;

static void GL_APIENTRY
_impl_glIndexPointer(GLenum type, GLsizei stride, const void *pointer)
{
	_glptr_glIndexPointer =
	    (PFN_glIndexPointer)GalogenGetProcAddress("glIndexPointer");
	_glptr_glIndexPointer(type, stride, pointer);
}
PFN_glIndexPointer _glptr_glIndexPointer = _impl_glIndexPointer;

static void GL_APIENTRY
_impl_glCopyPixels(GLint x, GLint y, GLsizei width, GLsizei height, GLenum type)
{
	_glptr_glCopyPixels =
	    (PFN_glCopyPixels)GalogenGetProcAddress("glCopyPixels");
	_glptr_glCopyPixels(x, y, width, height, type);
}
PFN_glCopyPixels _glptr_glCopyPixels = _impl_glCopyPixels;

static void GL_APIENTRY
_impl_glTexCoord1dv(const GLdouble *v)
{
	_glptr_glTexCoord1dv =
	    (PFN_glTexCoord1dv)GalogenGetProcAddress("glTexCoord1dv");
	_glptr_glTexCoord1dv(v);
}
PFN_glTexCoord1dv _glptr_glTexCoord1dv = _impl_glTexCoord1dv;

static void GL_APIENTRY
_impl_glEvalCoord1d(GLdouble u)
{
	_glptr_glEvalCoord1d =
	    (PFN_glEvalCoord1d)GalogenGetProcAddress("glEvalCoord1d");
	_glptr_glEvalCoord1d(u);
}
PFN_glEvalCoord1d _glptr_glEvalCoord1d = _impl_glEvalCoord1d;

static void GL_APIENTRY
_impl_glVertexAttrib4bv(GLuint index, const GLbyte *v)
{
	_glptr_glVertexAttrib4bv =
	    (PFN_glVertexAttrib4bv)GalogenGetProcAddress("glVertexAttrib4bv");
...
{
	_glptr_glMapGrid2f =
	    (PFN_glMapGrid2f)GalogenGetProcAddress("glMapGrid2f");
	_glptr_glMapGrid2f(un, u1, u2, vn, v1, v2);
}
PFN_glMapGrid2f _glptr_glMapGrid2f = _impl_glMapGrid2f;

static void GL_APIENTRY
_impl_glEvalCoord2f(GLfloat u, GLfloat v)
{
	_glptr_glEvalCoord2f =
	    (PFN_glEvalCoord2f)GalogenGetProcAddress("glEvalCoord2f");
	_glptr_glEvalCoord2f(u, v);
}
PFN_glEvalCoord2f _glptr_glEvalCoord2f = _impl_glEvalCoord2f;

static void GL_APIENTRY
_impl_glMapGrid1d(GLint un, GLdouble u1, GLdouble u2)
{
	_glptr_glMapGrid1d =
	    (PFN_glMapGrid1d)GalogenGetProcAddress("glMapGrid1d");
	_glptr_glMapGrid1d(un, u1, u2);
}
PFN_glMapGrid1d _glptr_glMapGrid1d = _impl_glMapGrid1d;

static void GL_APIENTRY
_impl_glMap2d(GLenum target, GLdouble u1, GLdouble u2, GLint ustride,
...
static void GL_APIENTRY
_impl_glMap1f(GLenum target, GLfloat u1, GLfloat u2, GLint stride, GLint order,
...
static void GL_APIENTRY
_impl_glUniform2uiv(GLint location, GLsizei count, const GLuint *value)
{
	_glptr_glUniform2uiv =
	    (PFN_glUniform2uiv)GalogenGetProcAddress("glUniform2uiv");
	_glptr_glUniform2uiv(location, count, value);
}
PFN_glUniform2uiv _glptr_glUniform2uiv = _impl_glUniform2uiv;

static void GL_APIENTRY
_impl_glMultiTexCoord1s(GLenum target, GLshort s)
{
	_glptr_glMultiTexCoord1s =
	    (PFN_glMultiTexCoord1s)GalogenGetProcAddress("glMultiTexCoord1s");
	_glptr_glMultiTexCoord1s(target, s);
}
PFN_glMultiTexCoord1s _glptr_glMultiTexCoord1s = _impl_glMultiTexCoord1s;

static void GL_APIENTRY
_impl_glGetShaderSource(
    GLuint shader, GLsizei bufSize, GLsizei *length, GLchar *source)
{
	_glptr_glGetShaderSource =
	    (PFN_glGetShaderSource)GalogenGetProcAddress("glGetShaderSource");
...
static GLboolean GL_APIENTRY
_impl_glIsBuffer(GLuint buffer)
{
...
static void GL_APIENTRY
_impl_glColor3ub(GLubyte red, GLubyte green, GLubyte blue)
{
...
static void GL_APIENTRY
_impl_glRasterPos4sv(const GLshort *v)
{
	_glptr_glRasterPos4sv =
	    (PFN_glRasterPos4sv)GalogenGetProcAddress("glRasterPos4sv");
	_glptr_glRasterPos4sv(v);
}
PFN_glRasterPos4sv _glptr_glRasterPos4sv = _impl_glRasterPos4sv;

static void GL_APIENTRY
_impl_glPushAttrib(GLbitfield mask)
{
	_glptr_glPushAttrib =
	    (PFN_glPushAttrib)GalogenGetProcAddress("glPushAttrib");
	_glptr_glPushAttrib(mask);
}
PFN_glPushAttrib _glptr_glPushAttrib = _impl_glPushAttrib;

static void GL_APIENTRY
_impl_glGetTexGendv(GLenum coord, GLenum pname, GLdouble *params)
{
	_glptr_glGetTexGendv =
	    (PFN_glGetTexGendv)GalogenGetProcAddress("glGetTexGendv");
	_glptr_glGetTexGendv(coord, pname, params);
}
PFN_glGetTexGendv _glptr_glGetTexGendv = _impl_glGetTexGendv;

static void GL_APIENTRY
_impl_glGetBufferPointerv(GLenum target, GLenum pname, void **params)
{
	_glptr_glGetBufferPointerv =
	    (PFN_glGetBufferPointerv)GalogenGetProcAddress(
		"glGetBufferPointerv");
...
static void GL_APIENTRY
_impl_glPolygonMode(GLenum face, GLenum mode)
{
	_glptr_glPolygonMode =
	    (PFN_glPolygonMode)GalogenGetProcAddress("glPolygonMode");
	_glptr_glPolygonMode(face, mode);
}
PFN_glPolygonMode _glptr_glPolygonMode = _impl_glPolygonMode;

static void GL_APIENTRY
_impl_glEdgeFlagv(const GLboolean *flag)
{
	_glptr_glEdgeFlagv =
	    (PFN_glEdgeFlagv)GalogenGetProcAddress("glEdgeFlagv");
	_glptr_glEdgeFlagv(flag);
}
PFN_glEdgeFlagv _glptr_glEdgeFlagv = _impl_glEdgeFlagv;

static void GL_APIENTRY
_impl_glGetTexEnviv(GLenum target, GLenum pname, GLint *params)
{
	_glptr_glGetTexEnviv =
	    (PFN_glGetTexEnviv)GalogenGetProcAddress("glGetTexEnviv");
	_glptr_glGetTexEnviv(target, pname, params);
}
PFN_glGetTexEnviv _glptr_glGetTexEnviv = _impl_glGetTexEnviv;

static void GL_APIENTRY
_impl_glBindAttribLocation(GLuint program, GLuint index, const GLchar *name)
{
	_glptr_glBindAttribLocation =
	    (PFN_glBindAttribLocation)GalogenGetProcAddress(
		"glBindAttribLocation");
	_glptr_glBindAttribLocation(program, index, name);
}
PFN_glBindAttribLocation _glptr_glBindAttribLocation =
    _impl_glBindAttribLocation;

static void GL_APIENTRY
_impl_glBitmap(GLsizei width, GLsizei height, GLfloat xorig, GLfloat yorig,
...
static void GL_APIENTRY
_impl_glAccum(GLenum op, GLfloat value)
{
...
static void GL_APIENTRY
_impl_glClearAccum(GLfloat red, GLfloat green, GLfloat blue, GLfloat alpha)
{
	_glptr_glClearAccum =
	    (PFN_glClearAccum)GalogenGetProcAddress("glClearAccum");
...
static void GL_APIENTRY
_impl_glPassThrough(GLfloat token)
{
	_glptr_glPassThrough =
	    (PFN_glPassThrough)GalogenGetProcAddress("glPassThrough");
	_glptr_glPassThrough(token);
}
PFN_glPassThrough _glptr_glPassThrough = _impl_glPassThrough;

static void GL_APIENTRY
_impl_glMultiTexCoord3dv(GLenum target, const GLdouble *v)
{
	_glptr_glMultiTexCoord3dv =
	    (PFN_glMultiTexCoord3dv)GalogenGetProcAddress("glMultiTexCoord3dv");
	_glptr_glMultiTexCoord3dv(target, v);
}
PFN_glMultiTexCoord3dv _glptr_glMultiTexCoord3dv = _impl_glMultiTexCoord3dv;

static void GL_APIENTRY
_impl_glUniform2f(GLint location, GLfloat v0, GLfloat v1)
{
	_glptr_glUniform2f =
	    (PFN_glUniform2f)GalogenGetProcAddress("glUniform2f");
	_glptr_glUniform2f(location, v0, v1);
}
PFN_glUniform2f _glptr_glUniform2f = _impl_glUniform2f;

static void GL_APIENTRY
_impl_glPixelStoref(GLenum pname, GLfloat param)
{
	_glptr_glPixelStoref =
	    (PFN_glPixelStoref)GalogenGetProcAddress("glPixelStoref");
	_glptr_glPixelStoref(pname, param);
}
PFN_glPixelStoref _glptr_glPixelStoref = _impl_glPixelStoref;

static void GL_APIENTRY
_impl_glLoadName(GLuint name)
{
...
{
	_glptr_glInitNames =
	    (PFN_glInitNames)GalogenGetProcAddress("glInitNames");
	_glptr_glInitNames();
}
PFN_glInitNames _glptr_glInitNames = _impl_glInitNames;

static void GL_APIENTRY
_impl_glLogicOp(GLenum opcode)
{
...
static GLint GL_APIENTRY
_impl_glRenderMode(GLenum mode)
{
	_glptr_glRenderMode =
	    (PFN_glRenderMode)GalogenGetProcAddress("glRenderMode");
	return _glptr_glRenderMode(mode);
}
PFN_glRenderMode _glptr_glRenderMode = _impl_glRenderMode;

static GLuint GL_APIENTRY
_impl_glCreateShader(GLenum type)
{
	_glptr_glCreateShader =
	    (PFN_glCreateShader)GalogenGetProcAddress("glCreateShader");
	return _glptr_glCreateShader(type);
}
PFN_glCreateShader _glptr_glCreateShader = _impl_glCreateShader;

static void GL_APIENTRY
_impl_glSelectBuffer(GLsizei size, GLuint *buffer)
{
	_glptr_glSelectBuffer =
	    (PFN_glSelectBuffer)GalogenGetProcAddress("glSelectBuffer");
	_glptr_glSelectBuffer(size, buffer);
}
PFN_glSelectBuffer _glptr_glSelectBuffer = _impl_glSelectBuffer;

static void GL_APIENTRY
_impl_glVertex3s(GLshort x, GLshort y, GLshort z)
{
...
static void GL_APIENTRY
_impl_glRasterPos3d(GLdouble x, GLdouble y, GLdouble z)
{
	_glptr_glRasterPos3d =
	    (PFN_glRasterPos3d)GalogenGetProcAddress("glRasterPos3d");
	_glptr_glRasterPos3d(x, y, z);
}
PFN_glRasterPos3d _glptr_glRasterPos3d = _impl_glRasterPos3d;

static void GL_APIENTRY
_impl_glTexSubImage2D(GLenum target, GLint level, GLint xoffset, GLint yoffset,
    GLsizei width, GLsizei height, GLenum format, GLenum type,
    const void *pixels)
{
	_glptr_glTexSubImage2D =
	    (PFN_glTexSubImage2D)GalogenGetProcAddress("glTexSubImage2D");
	_glptr_glTexSubImage2D(target, level, xoffset, yoffset, width, height,
	    format, type, pixels);
}
PFN_glTexSubImage2D _glptr_glTexSubImage2D = _impl_glTexSubImage2D;

static void GL_APIENTRY
_impl_glClearDepth(GLdouble depth)
{
	_glptr_glClearDepth =
	    (PFN_glClearDepth)GalogenGetProcAddress("glClearDepth");
	_glptr_glClearDepth(depth);
}
PFN_glClearDepth _glptr_glClearDepth = _impl_glClearDepth;

static void GL_APIENTRY
_impl_glFeedbackBuffer(GLsizei size, GLenum type, GLfloat *buffer)
{
	_glptr_glFeedbackBuffer =
	    (PFN_glFeedbackBuffer)GalogenGetProcAddress("glFeedbackBuffer");
	_glptr_glFeedbackBuffer(size, type, buffer);
}
PFN_glFeedbackBuffer _glptr_glFeedbackBuffer = _impl_glFeedbackBuffer;

static void GL_APIENTRY
_impl_glEvalCoord2d(GLdouble u, GLdouble v)
{
	_glptr_glEvalCoord2d =
	    (PFN_glEvalCoord2d)GalogenGetProcAddress("glEvalCoord2d");
	_glptr_glEvalCoord2d(u, v);
}
PFN_glEvalCoord2d _glptr_glEvalCoord2d = _impl_glEvalCoord2d;

static void GL_APIENTRY
_impl_glTranslated(GLdouble x, GLdouble y, GLdouble z)
{
	_glptr_glTranslated =
	    (PFN_glTranslated)GalogenGetProcAddress("glTranslated");
	_glptr_glTranslated(x, y, z);
}
PFN_glTranslated _glptr_glTranslated = _impl_glTranslated;

static void GL_APIENTRY
_impl_glTexGeni(GLenum coord, GLenum pname, GLint param)
{
...
static void GL_APIENTRY
_impl_glSecondaryColor3ubv(const GLubyte *v)
{
	_glptr_glSecondaryColor3ubv =
	    (PFN_glSecondaryColor3ubv)GalogenGetProcAddress(
		"glSecondaryColor3ubv");
	_glptr_glSecondaryColor3ubv(v);
}
PFN_glSecondaryColor3ubv _glptr_glSecondaryColor3ubv =
    _impl_glSecondaryColor3ubv;

static void GL_APIENTRY
_impl_glTexCoord1d(GLdouble s)
{
	_glptr_glTexCoord1d =
	    (PFN_glTexCoord1d)GalogenGetProcAddress("glTexCoord1d");
	_glptr_glTexCoord1d(s);
}
PFN_glTexCoord1d _glptr_glTexCoord1d = _impl_glTexCoord1d;

static void GL_APIENTRY
_impl_glTexGenf(GLenum coord, GLenum pname, GLfloat param)
{
...
static void GL_APIENTRY
_impl_glMultiTexCoord1iv(GLenum target, const GLint *v)
{
	_glptr_glMultiTexCoord1iv =
	    (PFN_glMultiTexCoord1iv)GalogenGetProcAddress("glMultiTexCoord1iv");
	_glptr_glMultiTexCoord1iv(target, v);
}
PFN_glMultiTexCoord1iv _glptr_glMultiTexCoord1iv = _impl_glMultiTexCoord1iv;

static void GL_APIENTRY
_impl_glRasterPos3f(GLfloat x, GLfloat y, GLfloat z)
{
	_glptr_glRasterPos3f =
	    (PFN_glRasterPos3f)GalogenGetProcAddress("glRasterPos3f");
	_glptr_glRasterPos3f(x, y, z);
}
PFN_glRasterPos3f _glptr_glRasterPos3f = _impl_glRasterPos3f;

static void GL_APIENTRY
_impl_glTexGendv(GLenum coord, GLenum pname, const GLdouble *params)
{
...
static void GL_APIENTRY
_impl_glTexGend(GLenum coord, GLenum pname, GLdouble param)
{
...
static void GL_APIENTRY
_impl_glMultiTexCoord4sv(GLenum target, const GLshort *v)
{
	_glptr_glMultiTexCoord4sv =
	    (PFN_glMultiTexCoord4sv)GalogenGetProcAddress("glMultiTexCoord4sv");
	_glptr_glMultiTexCoord4sv(target, v);
}
PFN_glMultiTexCoord4sv _glptr_glMultiTexCoord4sv = _impl_glMultiTexCoord4sv;

static void GL_APIENTRY
_impl_glGetPolygonStipple(GLubyte *mask)
{
	_glptr_glGetPolygonStipple =
	    (PFN_glGetPolygonStipple)GalogenGetProcAddress(
		"glGetPolygonStipple");
...
static void GL_APIENTRY
_impl_glTexEnviv(GLenum target, GLenum pname, const GLint *params)
{
...
static void GL_APIENTRY
_impl_glMap2f(GLenum target, GLfloat u1, GLfloat u2, GLint ustride,
...
static void GL_APIENTRY
_impl_glTexEnvfv(GLenum target, GLenum pname, const GLfloat *params)
{
...
static void GL_APIENTRY
_impl_glIndexubv(const GLubyte *c)
{
...
static void GL_APIENTRY
_impl_glTexCoord4iv(const GLint *v)
{
	_glptr_glTexCoord4iv =
	    (PFN_glTexCoord4iv)GalogenGetProcAddress("glTexCoord4iv");
	_glptr_glTexCoord4iv(v);
}
PFN_glTexCoord4iv _glptr_glTexCoord4iv = _impl_glTexCoord4iv;

static void GL_APIENTRY
_impl_glMaterialfv(GLenum face, GLenum pname, const GLfloat *params)
{
	_glptr_glMaterialfv =
	    (PFN_glMaterialfv)GalogenGetProcAddress("glMaterialfv");
	_glptr_glMaterialfv(face, pname, params);
}
PFN_glMaterialfv _glptr_glMaterialfv = _impl_glMaterialfv;

static void GL_APIENTRY
_impl_glWindowPos2s(GLshort x, GLshort y)
{
	_glptr_glWindowPos2s =
	    (PFN_glWindowPos2s)GalogenGetProcAddress("glWindowPos2s");
	_glptr_glWindowPos2s(x, y);
}
PFN_glWindowPos2s _glptr_glWindowPos2s = _impl_glWindowPos2s;

static void GL_APIENTRY
_impl_glMaterialf(GLenum face, GLenum pname, GLfloat param)
{
	_glptr_glMaterialf =
	    (PFN_glMaterialf)GalogenGetProcAddress("glMaterialf");
	_glptr_glMaterialf(face, pname, param);
}
PFN_glMaterialf _glptr_glMaterialf = _impl_glMaterialf;

static void GL_APIENTRY
_impl_glVertexAttrib4uiv(GLuint index, const GLuint *v)
{
	_glptr_glVertexAttrib4uiv =
	    (PFN_glVertexAttrib4uiv)GalogenGetProcAddress("glVertexAttrib4uiv");
	_glptr_glVertexAttrib4uiv(index, v);
}
PFN_glVertexAttrib4uiv _glptr_glVertexAttrib4uiv = _impl_glVertexAttrib4uiv;

static void GL_APIENTRY
_impl_glLightModeliv(GLenum pname, const GLint *params)
{
	_glptr_glLightModeliv =
	    (PFN_glLightModeliv)GalogenGetProcAddress("glLightModeliv");
	_glptr_glLightModeliv(pname, params);
}
PFN_glLightModeliv _glptr_glLightModeliv = _impl_glLightModeliv;

static void GL_APIENTRY
_impl_glTexGeniv(GLenum coord, GLenum pname, const GLint *params)
{
...
static void GL_APIENTRY
_impl_glFramebufferTexture2D(GLenum target, GLenum attachment, GLenum textarget,
    GLuint texture, GLint level)
{
	_glptr_glFramebufferTexture2D =
	    (PFN_glFramebufferTexture2D)GalogenGetProcAddress(
		"glFramebufferTexture2D");
	_glptr_glFramebufferTexture2D(
	    target, attachment, textarget, texture, level);
}
PFN_glFramebufferTexture2D _glptr_glFramebufferTexture2D =
    _impl_glFramebufferTexture2D;

static void GL_APIENTRY
_impl_glLightModelfv(GLenum pname, const GLfloat *params)
{
	_glptr_glLightModelfv =
	    (PFN_glLightModelfv)GalogenGetProcAddress("glLightModelfv");
	_glptr_glLightModelfv(pname, params);
}
PFN_glLightModelfv _glptr_glLightModelfv = _impl_glLightModelfv;

static void GL_APIENTRY
_impl_glLoadIdentity()
{
	_glptr_glLoadIdentity =
	    (PFN_glLoadIdentity)GalogenGetProcAddress("glLoadIdentity");
	_glptr_glLoadIdentity();
}
PFN_glLoadIdentity _glptr_glLoadIdentity = _impl_glLoadIdentity;

static void GL_APIENTRY
_impl_glLightModelf(GLenum pname, GLfloat param)
{
	_glptr_glLightModelf =
	    (PFN_glLightModelf)GalogenGetProcAddress("glLightModelf");
	_glptr_glLightModelf(pname, param);
}
PFN_glLightModelf _glptr_glLightModelf = _impl_glLightModelf;

static void GL_APIENTRY
_impl_glTexCoord4f(GLfloat s, GLfloat t, GLfloat r, GLfloat q)
{
	_glptr_glTexCoord4f =
	    (PFN_glTexCoord4f)GalogenGetProcAddress("glTexCoord4f");
	_glptr_glTexCoord4f(s, t, r, q);
}
PFN_glTexCoord4f _glptr_glTexCoord4f = _impl_glTexCoord4f;

static void GL_APIENTRY
_impl_glColor3d(GLdouble red, GLdouble green, GLdouble blue)
{
...
static void GL_APIENTRY
_impl_glMultiTexCoord2sv(GLenum target, const GLshort *v)
{
	_glptr_glMultiTexCoord2sv =
	    (PFN_glMultiTexCoord2sv)GalogenGetProcAddress("glMultiTexCoord2sv");
	_glptr_glMultiTexCoord2sv(target, v);
}
PFN_glMultiTexCoord2sv _glptr_glMultiTexCoord2sv = _impl_glMultiTexCoord2sv;

static void GL_APIENTRY
_impl_glLightiv(GLenum light, GLenum pname, const GLint *params)
{
...
static void GL_APIENTRY
_impl_glLighti(GLenum light, GLenum pname, GLint param)
{
...
static void GL_APIENTRY
_impl_glPointParameterf(GLenum pname, GLfloat param)
{
	_glptr_glPointParameterf =
	    (PFN_glPointParameterf)GalogenGetProcAddress("glPointParameterf");
	_glptr_glPointParameterf(pname, param);
}
PFN_glPointParameterf _glptr_glPointParameterf = _impl_glPointParameterf;

static void GL_APIENTRY
_impl_glDisablei(GLenum target, GLuint index)
{
...
static void GL_APIENTRY
_impl_glFogi(GLenum pname, GLint param)
{
...
static void GL_APIENTRY
_impl_glEvalCoord1fv(const GLfloat *u)
{
	_glptr_glEvalCoord1fv =
	    (PFN_glEvalCoord1fv)GalogenGetProcAddress("glEvalCoord1fv");
	_glptr_glEvalCoord1fv(u);
}
PFN_glEvalCoord1fv _glptr_glEvalCoord1fv = _impl_glEvalCoord1fv;

static void GL_APIENTRY
_impl_glFogf(GLenum pname, GLfloat param)
{
...
static void GL_APIENTRY
_impl_glColorMaterial(GLenum face, GLenum mode)
{
	_glptr_glColorMaterial =
	    (PFN_glColorMaterial)GalogenGetProcAddress("glColorMaterial");
	_glptr_glColorMaterial(face, mode);
}
PFN_glColorMaterial _glptr_glColorMaterial = _impl_glColorMaterial;

static void GL_APIENTRY
_impl_glClipPlane(GLenum plane, const GLdouble *equation)
{
	_glptr_glClipPlane =
	    (PFN_glClipPlane)GalogenGetProcAddress("glClipPlane");
	_glptr_glClipPlane(plane, equation);
}
PFN_glClipPlane _glptr_glClipPlane = _impl_glClipPlane;

static void GL_APIENTRY
_impl_glWindowPos3sv(const GLshort *v)
{
	_glptr_glWindowPos3sv =
	    (PFN_glWindowPos3sv)GalogenGetProcAddress("glWindowPos3sv");
	_glptr_glWindowPos3sv(v);
}
PFN_glWindowPos3sv _glptr_glWindowPos3sv = _impl_glWindowPos3sv;

static void GL_APIENTRY
_impl_glVertex4sv(const GLshort *v)
{
	_glptr_glVertex4sv =
	    (PFN_glVertex4sv)GalogenGetProcAddress("glVertex4sv");
	_glptr_glVertex4sv(v);
}
PFN_glVertex4sv _glptr_glVertex4sv = _impl_glVertex4sv;

static void GL_APIENTRY
_impl_glUniformMatrix4x2fv(
    GLint location, GLsizei count, GLboolean transpose, const GLfloat *value)
{
	_glptr_glUniformMatrix4x2fv =
	    (PFN_glUniformMatrix4x2fv)GalogenGetProcAddress(
		"glUniformMatrix4x2fv");
	_glptr_glUniformMatrix4x2fv(location, count, transpose, value);
}
PFN_glUniformMatrix4x2fv _glptr_glUniformMatrix4x2fv =
    _impl_glUniformMatrix4x2fv;

static void GL_APIENTRY
_impl_glMultiTexCoord4fv(GLenum target, const GLfloat *v)
{
	_glptr_glMultiTexCoord4fv =
	    (PFN_glMultiTexCoord4fv)GalogenGetProcAddress("glMultiTexCoord4fv");
	_glptr_glMultiTexCoord4fv(target, v);
}
PFN_glMultiTexCoord4fv _glptr_glMultiTexCoord4fv = _impl_glMultiTexCoord4fv;

static void GL_APIENTRY
_impl_glVertex4s(GLshort x, GLshort y, GLshort z, GLshort w)
{
...
static void GL_APIENTRY
_impl_glEvalCoord1dv(const GLdouble *u)
{
	_glptr_glEvalCoord1dv =
	    (PFN_glEvalCoord1dv)GalogenGetProcAddress("glEvalCoord1dv");
	_glptr_glEvalCoord1dv(u);
}
PFN_glEvalCoord1dv _glptr_glEvalCoord1dv = _impl_glEvalCoord1dv;

static void GL_APIENTRY
_impl_glFogfv(GLenum pname, const GLfloat *params)
{
...
static void GL_APIENTRY
_impl_glTexParameterIuiv(GLenum target, GLenum pname, const GLuint *params)
{
	_glptr_glTexParameterIuiv =
	    (PFN_glTexParameterIuiv)GalogenGetProcAddress("glTexParameterIuiv");
	_glptr_glTexParameterIuiv(target, pname, params);
}
PFN_glTexParameterIuiv _glptr_glTexParameterIuiv = _impl_glTexParameterIuiv;

static void GL_APIENTRY
_impl_glColor4i(GLint red, GLint green, GLint blue, GLint alpha)
{
...
static void GL_APIENTRY
_impl_glVertex3f(GLfloat x, GLfloat y, GLfloat z)
{
...
static void GL_APIENTRY
_impl_glTexCoord4fv(const GLfloat *v)
{
	_glptr_glTexCoord4fv =
	    (PFN_glTexCoord4fv)GalogenGetProcAddress("glTexCoord4fv");
	_glptr_glTexCoord4fv(v);
}
PFN_glTexCoord4fv _glptr_glTexCoord4fv = _impl_glTexCoord4fv;

static void GL_APIENTRY
_impl_glEvalMesh2(GLenum mode, GLint i1, GLint i2, GLint j1, GLint j2)
{
	_glptr_glEvalMesh2 =
	    (PFN_glEvalMesh2)GalogenGetProcAddress("glEvalMesh2");
	_glptr_glEvalMesh2(mode, i1, i2, j1, j2);
}
PFN_glEvalMesh2 _glptr_glEvalMesh2 = _impl_glEvalMesh2;

static void GL_APIENTRY
_impl_glGetFloatv(GLenum pname, GLfloat *data)
{
	_glptr_glGetFloatv =
	    (PFN_glGetFloatv)GalogenGetProcAddress("glGetFloatv");
	_glptr_glGetFloatv(pname, data);
}
PFN_glGetFloatv _glptr_glGetFloatv = _impl_glGetFloatv;

static void GL_APIENTRY
_impl_glVertex3d(GLdouble x, GLdouble y, GLdouble z)
{
...
static GLuint GL_APIENTRY
_impl_glCreateProgram()
{
	_glptr_glCreateProgram =
	    (PFN_glCreateProgram)GalogenGetProcAddress("glCreateProgram");
	return _glptr_glCreateProgram();
}
PFN_glCreateProgram _glptr_glCreateProgram = _impl_glCreateProgram;

static void GL_APIENTRY
_impl_glVertex2iv(const GLint *v)
{
	_glptr_glVertex2iv =
	    (PFN_glVertex2iv)GalogenGetProcAddress("glVertex2iv");
	_glptr_glVertex2iv(v);
}
PFN_glVertex2iv _glptr_glVertex2iv = _impl_glVertex2iv;

static void GL_APIENTRY
_impl_glTexGenfv(GLenum coord, GLenum pname, const GLfloat *params)
{
...
static void GL_APIENTRY
_impl_glColor3iv(const GLint *v)
{
...
static void GL_APIENTRY
_impl_glTexCoord4sv(const GLshort *v)
{
	_glptr_glTexCoord4sv =
	    (PFN_glTexCoord4sv)GalogenGetProcAddress("glTexCoord4sv");
	_glptr_glTexCoord4sv(v);
}
PFN_glTexCoord4sv _glptr_glTexCoord4sv = _impl_glTexCoord4sv;

static void GL_APIENTRY
_impl_glTexCoord4i(GLint s, GLint t, GLint r, GLint q)
{
	_glptr_glTexCoord4i =
	    (PFN_glTexCoord4i)GalogenGetProcAddress("glTexCoord4i");
	_glptr_glTexCoord4i(s, t, r, q);
}
PFN_glTexCoord4i _glptr_glTexCoord4i = _impl_glTexCoord4i;

static void GL_APIENTRY
_impl_glVertex2d(GLdouble x, GLdouble y)
{
...
static void GL_APIENTRY
_impl_glTransformFeedbackVaryings(GLuint program, GLsizei count,
    const GLchar *const *varyings, GLenum bufferMode)
{
	_glptr_glTransformFeedbackVaryings =
	    (PFN_glTransformFeedbackVaryings)GalogenGetProcAddress(
		"glTransformFeedbackVaryings");
	_glptr_glTransformFeedbackVaryings(
	    program, count, varyings, bufferMode);
}
PFN_glTransformFeedbackVaryings _glptr_glTransformFeedbackVaryings =
    _impl_glTransformFeedbackVaryings;

static void GL_APIENTRY
_impl_glSecondaryColor3s(GLshort red, GLshort green, GLshort blue)
{
	_glptr_glSecondaryColor3s =
	    (PFN_glSecondaryColor3s)GalogenGetProcAddress("glSecondaryColor3s");
	_glptr_glSecondaryColor3s(red, green, blue);
}
PFN_glSecondaryColor3s _glptr_glSecondaryColor3s = _impl_glSecondaryColor3s;

static void GL_APIENTRY
_impl_glTexCoord4d(GLdouble s, GLdouble t, GLdouble r, GLdouble q)
{
	_glptr_glTexCoord4d =
	    (PFN_glTexCoord4d)GalogenGetProcAddress("glTexCoord4d");
	_glptr_glTexCoord4d(s, t, r, q);
}
PFN_glTexCoord4d _glptr_glTexCoord4d = _impl_glTexCoord4d;

static void GL_APIENTRY
_impl_glTexCoord2fv(const GLfloat *v)
{
	_glptr_glTexCoord2fv =
	    (PFN_glTexCoord2fv)GalogenGetProcAddress("glTexCoord2fv");
	_glptr_glTexCoord2fv(v);
}
PFN_glTexCoord2fv _glptr_glTexCoord2fv = _impl_glTexCoord2fv;

static void GL_APIENTRY
_impl_glTexCoord3i(GLint s, GLint t, GLint r)
{
	_glptr_glTexCoord3i =
	    (PFN_glTexCoord3i)GalogenGetProcAddress("glTexCoord3i");
	_glptr_glTexCoord3i(s, t, r);
}
PFN_glTexCoord3i _glptr_glTexCoord3i = _impl_glTexCoord3i;

static void GL_APIENTRY
_impl_glVertexAttrib1d(GLuint index, GLdouble x)
{
	_glptr_glVertexAttrib1d =
	    (PFN_glVertexAttrib1d)GalogenGetProcAddress("glVertexAttrib1d");
	_glptr_glVertexAttrib1d(index, x);
}
PFN_glVertexAttrib1d _glptr_glVertexAttrib1d = _impl_glVertexAttrib1d;

static void GL_APIENTRY
_impl_glMultiTexCoord2dv(GLenum target, const GLdouble *v)
{
	_glptr_glMultiTexCoord2dv =
	    (PFN_glMultiTexCoord2dv)GalogenGetProcAddress("glMultiTexCoord2dv");
	_glptr_glMultiTexCoord2dv(target, v);
}
PFN_glMultiTexCoord2dv _glptr_glMultiTexCoord2dv = _impl_glMultiTexCoord2dv;

static void GL_APIENTRY
_impl_glTexCoord3fv(const GLfloat *v)
{
	_glptr_glTexCoord3fv =
	    (PFN_glTexCoord3fv)GalogenGetProcAddress("glTexCoord3fv");
	_glptr_glTexCoord3fv(v);
}
PFN_glTexCoord3fv _glptr_glTexCoord3fv = _impl_glTexCoord3fv;

static void GL_APIENTRY
_impl_glViewport(GLint x, GLint y, GLsizei width, GLsizei height)
{
...
static void GL_APIENTRY
_impl_glTexCoord2sv(const GLshort *v)
{
	_glptr_glTexCoord2sv =
	    (PFN_glTexCoord2sv)GalogenGetProcAddress("glTexCoord2sv");
	_glptr_glTexCoord2sv(v);
}
PFN_glTexCoord2sv _glptr_glTexCoord2sv = _impl_glTexCoord2sv;

static void GL_APIENTRY
_impl_glDeleteBuffers(GLsizei n, const GLuint *buffers)
{
	_glptr_glDeleteBuffers =
	    (PFN_glDeleteBuffers)GalogenGetProcAddress("glDeleteBuffers");
	_glptr_glDeleteBuffers(n, buffers);
}
PFN_glDeleteBuffers _glptr_glDeleteBuffers = _impl_glDeleteBuffers;

static void GL_APIENTRY
_impl_glColor3dv(const GLdouble *v)
{
...
static void GL_APIENTRY
_impl_glTexCoord2i(GLint s, GLint t)
{
	_glptr_glTexCoord2i =
	    (PFN_glTexCoord2i)GalogenGetProcAddress("glTexCoord2i");
	_glptr_glTexCoord2i(s, t);
}
PFN_glTexCoord2i _glptr_glTexCoord2i = _impl_glTexCoord2i;

static void GL_APIENTRY
_impl_glTexCoord2f(GLfloat s, GLfloat t)
{
	_glptr_glTexCoord2f =
	    (PFN_glTexCoord2f)GalogenGetProcAddress("glTexCoord2f");
...
static void GL_APIENTRY
_impl_glTexCoord1sv(const GLshort *v)
{
	_glptr_glTexCoord1sv =
	    (PFN_glTexCoord1sv)GalogenGetProcAddress("glTexCoord1sv");
	_glptr_glTexCoord1sv(v);
}
PFN_glTexCoord1sv _glptr_glTexCoord1sv = _impl_glTexCoord1sv;

static void GL_APIENTRY
_impl_glLoadMatrixf(const GLfloat *m)
{
	_glptr_glLoadMatrixf =
	    (PFN_glLoadMatrixf)GalogenGetProcAddress("glLoadMatrixf");
	_glptr_glLoadMatrixf(m);
}
PFN_glLoadMatrixf _glptr_glLoadMatrixf = _impl_glLoadMatrixf;

static void GL_APIENTRY
_impl_glTexCoord1iv(const GLint *v)
{
	_glptr_glTexCoord1iv =
	    (PFN_glTexCoord1iv)GalogenGetProcAddress("glTexCoord1iv");
	_glptr_glTexCoord1iv(v);
}
PFN_glTexCoord1iv _glptr_glTexCoord1iv = _impl_glTexCoord1iv;

static void GL_APIENTRY
_impl_glVertexAttribI4sv(GLuint index, const GLshort *v)
{
	_glptr_glVertexAttribI4sv =
	    (PFN_glVertexAttribI4sv)GalogenGetProcAddress("glVertexAttribI4sv");
	_glptr_glVertexAttribI4sv(index, v);
}
PFN_glVertexAttribI4sv _glptr_glVertexAttribI4sv = _impl_glVertexAttribI4sv;

static void GL_APIENTRY
_impl_glDrawArrays(GLenum mode, GLint first, GLsizei count)
{
	_glptr_glDrawArrays =
	    (PFN_glDrawArrays)GalogenGetProcAddress("glDrawArrays");
	_glptr_glDrawArrays(mode, first, count);
}
PFN_glDrawArrays _glptr_glDrawArrays = _impl_glDrawArrays;

static void GL_APIENTRY
_impl_glTexCoord1fv(const GLfloat *v)
{
	_glptr_glTexCoord1fv =
	    (PFN_glTexCoord1fv)GalogenGetProcAddress("glTexCoord1fv");
	_glptr_glTexCoord1fv(v);
}
PFN_glTexCoord1fv _glptr_glTexCoord1fv = _impl_glTexCoord1fv;

static void GL_APIENTRY
_impl_glRectfv(const GLfloat *v1, const GLfloat *v2)
{
...
static void GL_APIENTRY
_impl_glRectdv(const GLdouble *v1, const GLdouble *v2)
{
...
static void GL_APIENTRY
_impl_glUniform3iv(GLint location, GLsizei count, const GLint *value)
{
	_glptr_glUniform3iv =
	    (PFN_glUniform3iv)GalogenGetProcAddress("glUniform3iv");
	_glptr_glUniform3iv(location, count, value);
}
PFN_glUniform3iv _glptr_glUniform3iv = _impl_glUniform3iv;

static void GL_APIENTRY
_impl_glRectd(GLdouble x1, GLdouble y1, GLdouble x2, GLdouble y2)
{
...
static void GL_APIENTRY
_impl_glMap1d(GLenum target, GLdouble u1, GLdouble u2, GLint stride,
...
static void GL_APIENTRY
_impl_glRasterPos3i(GLint x, GLint y, GLint z)
{
	_glptr_glRasterPos3i =
	    (PFN_glRasterPos3i)GalogenGetProcAddress("glRasterPos3i");
	_glptr_glRasterPos3i(x, y, z);
}
PFN_glRasterPos3i _glptr_glRasterPos3i = _impl_glRasterPos3i;

static void GL_APIENTRY
_impl_glVertexAttribPointer(GLuint index, GLint size, GLenum type,
    GLboolean normalized, GLsizei stride, const void *pointer)
{
	_glptr_glVertexAttribPointer =
	    (PFN_glVertexAttribPointer)GalogenGetProcAddress(
		"glVertexAttribPointer");
	_glptr_glVertexAttribPointer(
	    index, size, type, normalized, stride, pointer);
}
PFN_glVertexAttribPointer _glptr_glVertexAttribPointer =
    _impl_glVertexAttribPointer;

static void GL_APIENTRY
_impl_glTexCoord3f(GLfloat s, GLfloat t, GLfloat r)
{
	_glptr_glTexCoord3f =
	    (PFN_glTexCoord3f)GalogenGetProcAddress("glTexCoord3f");
	_glptr_glTexCoord3f(s, t, r);
}
PFN_glTexCoord3f _glptr_glTexCoord3f = _impl_glTexCoord3f;

static void GL_APIENTRY
_impl_glTexCoord1s(GLshort s)
{
	_glptr_glTexCoord1s =
	    (PFN_glTexCoord1s)GalogenGetProcAddress("glTexCoord1s");
	_glptr_glTexCoord1s(s);
}
PFN_glTexCoord1s _glptr_glTexCoord1s = _impl_glTexCoord1s;

static void GL_APIENTRY
_impl_glSecondaryColor3usv(const GLushort *v)
{
	_glptr_glSecondaryColor3usv =
	    (PFN_glSecondaryColor3usv)GalogenGetProcAddress(
		"glSecondaryColor3usv");
	_glptr_glSecondaryColor3usv(v);
}
PFN_glSecondaryColor3usv _glptr_glSecondaryColor3usv =
    _impl_glSecondaryColor3usv;

static void GL_APIENTRY
_impl_glRasterPos4s(GLshort x, GLshort y, GLshort z, GLshort w)
{
	_glptr_glRasterPos4s =
	    (PFN_glRasterPos4s)GalogenGetProcAddress("glRasterPos4s");
	_glptr_glRasterPos4s(x, y, z, w);
}
PFN_glRasterPos4s _glptr_glRasterPos4s = _impl_glRasterPos4s;

static void GL_APIENTRY
_impl_glUniform1i(GLint location, GLint v0)
{
	_glptr_glUniform1i =
	    (PFN_glUniform1i)GalogenGetProcAddress("glUniform1i");
	_glptr_glUniform1i(location, v0);
}
PFN_glUniform1i _glptr_glUniform1i = _impl_glUniform1i;

static void GL_APIENTRY
_impl_glRasterPos4fv(const GLfloat *v)
{
	_glptr_glRasterPos4fv =
	    (PFN_glRasterPos4fv)GalogenGetProcAddress("glRasterPos4fv");
	_glptr_glRasterPos4fv(v);
}
PFN_glRasterPos4fv _glptr_glRasterPos4fv = _impl_glRasterPos4fv;

static void GL_APIENTRY
_impl_glRasterPos2i(GLint x, GLint y)
{
	_glptr_glRasterPos2i =
	    (PFN_glRasterPos2i)GalogenGetProcAddress("glRasterPos2i");
	_glptr_glRasterPos2i(x, y);
}
PFN_glRasterPos2i _glptr_glRasterPos2i = _impl_glRasterPos2i;

static void GL_APIENTRY
_impl_glMultiTexCoord1d(GLenum target, GLdouble s)
{
	_glptr_glMultiTexCoord1d =
	    (PFN_glMultiTexCoord1d)GalogenGetProcAddress("glMultiTexCoord1d");
	_glptr_glMultiTexCoord1d(target, s);
}
PFN_glMultiTexCoord1d _glptr_glMultiTexCoord1d = _impl_glMultiTexCoord1d;

static void GL_APIENTRY
_impl_glVertexAttrib1sv(GLuint index, const GLshort *v)
{
	_glptr_glVertexAttrib1sv =
	    (PFN_glVertexAttrib1sv)GalogenGetProcAddress("glVertexAttrib1sv");
	_glptr_glVertexAttrib1sv(index, v);
}
PFN_glVertexAttrib1sv _glptr_glVertexAttrib1sv = _impl_glVertexAttrib1sv;

static void GL_APIENTRY
_impl_glIndexiv(const GLint *c)
{
...
static void GL_APIENTRY
_impl_glVertex2dv(const GLdouble *v)
{
	_glptr_glVertex2dv =
	    (PFN_glVertex2dv)GalogenGetProcAddress("glVertex2dv");
	_glptr_glVertex2dv(v);
}
PFN_glVertex2dv _glptr_glVertex2dv = _impl_glVertex2dv;

static void GL_APIENTRY
_impl_glRasterPos4f(GLfloat x, GLfloat y, GLfloat z, GLfloat w)
{
	_glptr_glRasterPos4f =
	    (PFN_glRasterPos4f)GalogenGetProcAddress("glRasterPos4f");
	_glptr_glRasterPos4f(x, y, z, w);
}
PFN_glRasterPos4f _glptr_glRasterPos4f = _impl_glRasterPos4f;

static void GL_APIENTRY
_impl_glVertex3fv(const GLfloat *v)
{
	_glptr_glVertex3fv =
	    (PFN_glVertex3fv)GalogenGetProcAddress("glVertex3fv");
	_glptr_glVertex3fv(v);
}
PFN_glVertex3fv _glptr_glVertex3fv = _impl_glVertex3fv;

static void GL_APIENTRY
_impl_glRasterPos4dv(const GLdouble *v)
{
	_glptr_glRasterPos4dv =
	    (PFN_glRasterPos4dv)GalogenGetProcAddress("glRasterPos4dv");
	_glptr_glRasterPos4dv(v);
}
PFN_glRasterPos4dv _glptr_glRasterPos4dv = _impl_glRasterPos4dv;

static void GL_APIENTRY
_impl_glDisable(GLenum cap)
{
...
static void GL_APIENTRY
_impl_glMultiTexCoord3fv(GLenum target, const GLfloat *v)
{
	_glptr_glMultiTexCoord3fv =
	    (PFN_glMultiTexCoord3fv)GalogenGetProcAddress("glMultiTexCoord3fv");
	_glptr_glMultiTexCoord3fv(target, v);
}
PFN_glMultiTexCoord3fv _glptr_glMultiTexCoord3fv = _impl_glMultiTexCoord3fv;

static GLboolean GL_APIENTRY
_impl_glAreTexturesResident(
    GLsizei n, const GLuint *textures, GLboolean *residences)
{
	_glptr_glAreTexturesResident =
	    (PFN_glAreTexturesResident)GalogenGetProcAddress(
		"glAreTexturesResident");
	return _glptr_glAreTexturesResident(n, textures, residences);
}
PFN_glAreTexturesResident _glptr_glAreTexturesResident =
    _impl_glAreTexturesResident;

static void GL_APIENTRY
_impl_glRasterPos4d(GLdouble x, GLdouble y, GLdouble z, GLdouble w)
{
	_glptr_glRasterPos4d =
	    (PFN_glRasterPos4d)GalogenGetProcAddress("glRasterPos4d");
	_glptr_glRasterPos4d(x, y, z, w);
}
PFN_glRasterPos4d _glptr_glRasterPos4d = _impl_glRasterPos4d;

static void GL_APIENTRY
_impl_glVertexAttribI4uiv(GLuint index, const GLuint *v)
{
	_glptr_glVertexAttribI4uiv =
	    (PFN_glVertexAttribI4uiv)GalogenGetProcAddress(
		"glVertexAttribI4uiv");
...
static void GL_APIENTRY
_impl_glEndQuery(GLenum target)
{
...
static void GL_APIENTRY
_impl_glRasterPos3s(GLshort x, GLshort y, GLshort z)
{
	_glptr_glRasterPos3s =
	    (PFN_glRasterPos3s)GalogenGetProcAddress("glRasterPos3s");
	_glptr_glRasterPos3s(x, y, z);
}
PFN_glRasterPos3s _glptr_glRasterPos3s = _impl_glRasterPos3s;

static void GL_APIENTRY
_impl_glMultiTexCoord2fv(GLenum target, const GLfloat *v)
{
	_glptr_glMultiTexCoord2fv =
	    (PFN_glMultiTexCoord2fv)GalogenGetProcAddress("glMultiTexCoord2fv");
...
{
	_glptr_glColorMask =
	    (PFN_glColorMask)GalogenGetProcAddress("glColorMask");
	_glptr_glColorMask(red, green, blue, alpha);
}
PFN_glColorMask _glptr_glColorMask = _impl_glColorMask;

static void GL_APIENTRY
_impl_glRasterPos4iv(const GLint *v)
{
	_glptr_glRasterPos4iv =
	    (PFN_glRasterPos4iv)GalogenGetProcAddress("glRasterPos4iv");
	_glptr_glRasterPos4iv(v);
}
PFN_glRasterPos4iv _glptr_glRasterPos4iv = _impl_glRasterPos4iv;

static void GL_APIENTRY
_impl_glVertex4dv(const GLdouble *v)
{
	_glptr_glVertex4dv =
	    (PFN_glVertex4dv)GalogenGetProcAddress("glVertex4dv");
	_glptr_glVertex4dv(v);
}
PFN_glVertex4dv _glptr_glVertex4dv = _impl_glVertex4dv;

static void GL_APIENTRY
_impl_glMultiTexCoord4dv(GLenum target, const GLdouble *v)
{
	_glptr_glMultiTexCoord4dv =
	    (PFN_glMultiTexCoord4dv)GalogenGetProcAddress("glMultiTexCoord4dv");
	_glptr_glMultiTexCoord4dv(target, v);
}
PFN_glMultiTexCoord4dv _glptr_glMultiTexCoord4dv = _impl_glMultiTexCoord4dv;

static void GL_APIENTRY
_impl_glEnablei(GLenum target, GLuint index)
{
...
static void GL_APIENTRY
_impl_glBindBuffer(GLenum target, GLuint buffer)
{
	_glptr_glBindBuffer =
	    (PFN_glBindBuffer)GalogenGetProcAddress("glBindBuffer");
	_glptr_glBindBuffer(target, buffer);
}
PFN_glBindBuffer _glptr_glBindBuffer = _impl_glBindBuffer;

static void GL_APIENTRY
_impl_glGetDoublev(GLenum pname, GLdouble *data)
{
	_glptr_glGetDoublev =
	    (PFN_glGetDoublev)GalogenGetProcAddress("glGetDoublev");
	_glptr_glGetDoublev(pname, data);
}
PFN_glGetDoublev _glptr_glGetDoublev = _impl_glGetDoublev;

static GLboolean GL_APIENTRY
_impl_glIsList(GLuint list)
{
...
static void GL_APIENTRY
_impl_glRasterPos3iv(const GLint *v)
{
	_glptr_glRasterPos3iv =
	    (PFN_glRasterPos3iv)GalogenGetProcAddress("glRasterPos3iv");
	_glptr_glRasterPos3iv(v);
}
PFN_glRasterPos3iv _glptr_glRasterPos3iv = _impl_glRasterPos3iv;

static void GL_APIENTRY
_impl_glGetTexParameteriv(GLenum target, GLenum pname, GLint *params)
{
	_glptr_glGetTexParameteriv =
	    (PFN_glGetTexParameteriv)GalogenGetProcAddress(
		"glGetTexParameteriv");
...
static void GL_APIENTRY
_impl_glTexCoord1f(GLfloat s)
{
	_glptr_glTexCoord1f =
	    (PFN_glTexCoord1f)GalogenGetProcAddress("glTexCoord1f");
	_glptr_glTexCoord1f(s);
}
PFN_glTexCoord1f _glptr_glTexCoord1f = _impl_glTexCoord1f;

static void GL_APIENTRY
_impl_glEdgeFlagPointer(GLsizei stride, const void *pointer)
{
	_glptr_glEdgeFlagPointer =
	    (PFN_glEdgeFlagPointer)GalogenGetProcAddress("glEdgeFlagPointer");
	_glptr_glEdgeFlagPointer(stride, pointer);
}
PFN_glEdgeFlagPointer _glptr_glEdgeFlagPointer = _impl_glEdgeFlagPointer;

static void GL_APIENTRY
_impl_glLightModeli(GLenum pname, GLint param)
{
	_glptr_glLightModeli =
	    (PFN_glLightModeli)GalogenGetProcAddress("glLightModeli");
	_glptr_glLightModeli(pname, param);
}
PFN_glLightModeli _glptr_glLightModeli = _impl_glLightModeli;

static void GL_APIENTRY
_impl_glVertex2f(GLfloat x, GLfloat y)
{
...
static void GL_APIENTRY
_impl_glRasterPos2s(GLshort x, GLshort y)
{
	_glptr_glRasterPos2s =
	    (PFN_glRasterPos2s)GalogenGetProcAddress("glRasterPos2s");
	_glptr_glRasterPos2s(x, y);
}
PFN_glRasterPos2s _glptr_glRasterPos2s = _impl_glRasterPos2s;

static void GL_APIENTRY
_impl_glDeleteVertexArrays(GLsizei n, const GLuint *arrays)
{
	_glptr_glDeleteVertexArrays =
	    (PFN_glDeleteVertexArrays)GalogenGetProcAddress(
		"glDeleteVertexArrays");
	_glptr_glDeleteVertexArrays(n, arrays);
}
PFN_glDeleteVertexArrays _glptr_glDeleteVertexArrays =
    _impl_glDeleteVertexArrays;

static void GL_APIENTRY
_impl_glVertexAttribI2uiv(GLuint index, const GLuint *v)
{
	_glptr_glVertexAttribI2uiv =
	    (PFN_glVertexAttribI2uiv)GalogenGetProcAddress(
		"glVertexAttribI2uiv");
...
static void GL_APIENTRY
_impl_glRasterPos2d(GLdouble x, GLdouble y)
{
	_glptr_glRasterPos2d =
	    (PFN_glRasterPos2d)GalogenGetProcAddress("glRasterPos2d");
	_glptr_glRasterPos2d(x, y);
}
PFN_glRasterPos2d _glptr_glRasterPos2d = _impl_glRasterPos2d;

static void GL_APIENTRY
_impl_glDepthMask(GLboolean flag)
{
	_glptr_glDepthMask =
	    (PFN_glDepthMask)GalogenGetProcAddress("glDepthMask");
	_glptr_glDepthMask(flag);
}
PFN_glDepthMask _glptr_glDepthMask = _impl_glDepthMask;

static void GL_APIENTRY
_impl_glNormal3sv(const GLshort *v)
{
	_glptr_glNormal3sv =
	    (PFN_glNormal3sv)GalogenGetProcAddress("glNormal3sv");
	_glptr_glNormal3sv(v);
}
PFN_glNormal3sv _glptr_glNormal3sv = _impl_glNormal3sv;

static void GL_APIENTRY
_impl_glGetVertexAttribdv(GLuint index, GLenum pname, GLdouble *params)
{
	_glptr_glGetVertexAttribdv =
	    (PFN_glGetVertexAttribdv)GalogenGetProcAddress(
		"glGetVertexAttribdv");
...
static void GL_APIENTRY
_impl_glDrawRangeElements(GLenum mode, GLuint start, GLuint end, GLsizei count,
    GLenum type, const void *indices)
{
	_glptr_glDrawRangeElements =
	    (PFN_glDrawRangeElements)GalogenGetProcAddress(
		"glDrawRangeElements");
...
static void GL_APIENTRY
_impl_glNormal3iv(const GLint *v)
{
	_glptr_glNormal3iv =
	    (PFN_glNormal3iv)GalogenGetProcAddress("glNormal3iv");
	_glptr_glNormal3iv(v);
}
PFN_glNormal3iv _glptr_glNormal3iv = _impl_glNormal3iv;

static void GL_APIENTRY
_impl_glRasterPos4i(GLint x, GLint y, GLint z, GLint w)
{
	_glptr_glRasterPos4i =
	    (PFN_glRasterPos4i)GalogenGetProcAddress("glRasterPos4i");
	_glptr_glRasterPos4i(x, y, z, w);
}
PFN_glRasterPos4i _glptr_glRasterPos4i = _impl_glRasterPos4i;

static void GL_APIENTRY
_impl_glPixelMapfv(GLenum map, GLsizei mapsize, const GLfloat *values)
{
	_glptr_glPixelMapfv =
	    (PFN_glPixelMapfv)GalogenGetProcAddress("glPixelMapfv");
	_glptr_glPixelMapfv(map, mapsize, values);
}
PFN_glPixelMapfv _glptr_glPixelMapfv = _impl_glPixelMapfv;

static void GL_APIENTRY
_impl_glNormal3i(GLint nx, GLint ny, GLint nz)
{
...
static void GL_APIENTRY
_impl_glFogCoordf(GLfloat coord)
{
	_glptr_glFogCoordf =
	    (PFN_glFogCoordf)GalogenGetProcAddress("glFogCoordf");
	_glptr_glFogCoordf(coord);
}
PFN_glFogCoordf _glptr_glFogCoordf = _impl_glFogCoordf;

static void GL_APIENTRY
_impl_glClearStencil(GLint s)
{
	_glptr_glClearStencil =
	    (PFN_glClearStencil)GalogenGetProcAddress("glClearStencil");
	_glptr_glClearStencil(s);
}
PFN_glClearStencil _glptr_glClearStencil = _impl_glClearStencil;

static void GL_APIENTRY
_impl_glRasterPos3sv(const GLshort *v)
{
	_glptr_glRasterPos3sv =
	    (PFN_glRasterPos3sv)GalogenGetProcAddress("glRasterPos3sv");
	_glptr_glRasterPos3sv(v);
}
PFN_glRasterPos3sv _glptr_glRasterPos3sv = _impl_glRasterPos3sv;

static void GL_APIENTRY
_impl_glVertexAttribI3iv(GLuint index, const GLint *v)
{
	_glptr_glVertexAttribI3iv =
	    (PFN_glVertexAttribI3iv)GalogenGetProcAddress("glVertexAttribI3iv");
	_glptr_glVertexAttribI3iv(index, v);
}
PFN_glVertexAttribI3iv _glptr_glVertexAttribI3iv = _impl_glVertexAttribI3iv;

static void GL_APIENTRY
_impl_glNormal3f(GLfloat nx, GLfloat ny, GLfloat nz)
{
...
static void GL_APIENTRY
_impl_glColor3ui(GLuint red, GLuint green, GLuint blue)
{
...
static void GL_APIENTRY
_impl_glOrtho(GLdouble left, GLdouble right, GLdouble bottom, GLdouble top,
    GLdouble zNear, GLdouble zFar)
{
...
static void GL_APIENTRY
_impl_glTexCoord2d(GLdouble s, GLdouble t)
{
	_glptr_glTexCoord2d =
	    (PFN_glTexCoord2d)GalogenGetProcAddress("glTexCoord2d");
	_glptr_glTexCoord2d(s, t);
}
PFN_glTexCoord2d _glptr_glTexCoord2d = _impl_glTexCoord2d;

static void GL_APIENTRY
_impl_glScissor(GLint x, GLint y, GLsizei width, GLsizei height)
{
...
static void GL_APIENTRY
_impl_glGenerateMipmap(GLenum target)
{
	_glptr_glGenerateMipmap =
	    (PFN_glGenerateMipmap)GalogenGetProcAddress("glGenerateMipmap");
	_glptr_glGenerateMipmap(target);
}
PFN_glGenerateMipmap _glptr_glGenerateMipmap = _impl_glGenerateMipmap;

static void GL_APIENTRY
_impl_glUniform3fv(GLint location, GLsizei count, const GLfloat *value)
{
	_glptr_glUniform3fv =
	    (PFN_glUniform3fv)GalogenGetProcAddress("glUniform3fv");
	_glptr_glUniform3fv(location, count, value);
}
PFN_glUniform3fv _glptr_glUniform3fv = _impl_glUniform3fv;

static void GL_APIENTRY
_impl_glNormal3d(GLdouble nx, GLdouble ny, GLdouble nz)
{
...
static void GL_APIENTRY
_impl_glMultiTexCoord2s(GLenum target, GLshort s, GLshort t)
{
	_glptr_glMultiTexCoord2s =
	    (PFN_glMultiTexCoord2s)GalogenGetProcAddress("glMultiTexCoord2s");
	_glptr_glMultiTexCoord2s(target, s, t);
}
PFN_glMultiTexCoord2s _glptr_glMultiTexCoord2s = _impl_glMultiTexCoord2s;

static void GL_APIENTRY
_impl_glUniform3uiv(GLint location, GLsizei count, const GLuint *value)
{
	_glptr_glUniform3uiv =
	    (PFN_glUniform3uiv)GalogenGetProcAddress("glUniform3uiv");
	_glptr_glUniform3uiv(location, count, value);
}
PFN_glUniform3uiv _glptr_glUniform3uiv = _impl_glUniform3uiv;

static void GL_APIENTRY
_impl_glNormal3bv(const GLbyte *v)
{
	_glptr_glNormal3bv =
	    (PFN_glNormal3bv)GalogenGetProcAddress("glNormal3bv");
	_glptr_glNormal3bv(v);
}
PFN_glNormal3bv _glptr_glNormal3bv = _impl_glNormal3bv;

static void GL_APIENTRY
_impl_glRasterPos3fv(const GLfloat *v)
{
	_glptr_glRasterPos3fv =
	    (PFN_glRasterPos3fv)GalogenGetProcAddress("glRasterPos3fv");
	_glptr_glRasterPos3fv(v);
}
PFN_glRasterPos3fv _glptr_glRasterPos3fv = _impl_glRasterPos3fv;

static void GL_APIENTRY
_impl_glNormal3b(GLbyte nx, GLbyte ny, GLbyte nz)
{
...
static void GL_APIENTRY
_impl_glClearBufferiv(GLenum buffer, GLint drawbuffer, const GLint *value)
{
	_glptr_glClearBufferiv =
	    (PFN_glClearBufferiv)GalogenGetProcAddress("glClearBufferiv");
	_glptr_glClearBufferiv(buffer, drawbuffer, value);
}
PFN_glClearBufferiv _glptr_glClearBufferiv = _impl_glClearBufferiv;

static void GL_APIENTRY
_impl_glIndexi(GLint c)
{
...
static void GL_APIENTRY
_impl_glTexCoord4s(GLshort s, GLshort t, GLshort r, GLshort q)
{
	_glptr_glTexCoord4s =
	    (PFN_glTexCoord4s)GalogenGetProcAddress("glTexCoord4s");
	_glptr_glTexCoord4s(s, t, r, q);
}
PFN_glTexCoord4s _glptr_glTexCoord4s = _impl_glTexCoord4s;

static void GL_APIENTRY
_impl_glClientActiveTexture(GLenum texture)
{
	_glptr_glClientActiveTexture =
	    (PFN_glClientActiveTexture)GalogenGetProcAddress(
		"glClientActiveTexture");
	_glptr_glClientActiveTexture(texture);
}
PFN_glClientActiveTexture _glptr_glClientActiveTexture =
    _impl_glClientActiveTexture;

static void GL_APIENTRY
_impl_glVertexAttribI4ubv(GLuint index, const GLubyte *v)
{
	_glptr_glVertexAttribI4ubv =
	    (PFN_glVertexAttribI4ubv)GalogenGetProcAddress(
		"glVertexAttribI4ubv");
...
static void GL_APIENTRY
_impl_glGetClipPlane(GLenum plane, GLdouble *equation)
{
	_glptr_glGetClipPlane =
	    (PFN_glGetClipPlane)GalogenGetProcAddress("glGetClipPlane");
	_glptr_glGetClipPlane(plane, equation);
}
PFN_glGetClipPlane _glptr_glGetClipPlane = _impl_glGetClipPlane;

static void GL_APIENTRY
_impl_glScalef(GLfloat x, GLfloat y, GLfloat z)
{
...
static void GL_APIENTRY
_impl_glGetBooleanv(GLenum pname, GLboolean *data)
{
	_glptr_glGetBooleanv =
	    (PFN_glGetBooleanv)GalogenGetProcAddress("glGetBooleanv");
	_glptr_glGetBooleanv(pname, data);
}
PFN_glGetBooleanv _glptr_glGetBooleanv = _impl_glGetBooleanv;

static void GL_APIENTRY
_impl_glIndexf(GLfloat c)
{
...
static void GL_APIENTRY
_impl_glVertex4i(GLint x, GLint y, GLint z, GLint w)
{
...
static void GL_APIENTRY
_impl_glValidateProgram(GLuint program)
{
	_glptr_glValidateProgram =
	    (PFN_glValidateProgram)GalogenGetProcAddress("glValidateProgram");
	_glptr_glValidateProgram(program);
}
PFN_glValidateProgram _glptr_glValidateProgram = _impl_glValidateProgram;

static void GL_APIENTRY
_impl_glColor4uiv(const GLuint *v)
{
	_glptr_glColor4uiv =
	    (PFN_glColor4uiv)GalogenGetProcAddress("glColor4uiv");
	_glptr_glColor4uiv(v);
}
PFN_glColor4uiv _glptr_glColor4uiv = _impl_glColor4uiv;

static void GL_APIENTRY
_impl_glTexCoord2s(GLshort s, GLshort t)
{
	_glptr_glTexCoord2s =
	    (PFN_glTexCoord2s)GalogenGetProcAddress("glTexCoord2s");
	_glptr_glTexCoord2s(s, t);
}
PFN_glTexCoord2s _glptr_glTexCoord2s = _impl_glTexCoord2s;

static void GL_APIENTRY
_impl_glIndexd(GLdouble c)
{
...
static void GL_APIENTRY
_impl_glColor4sv(const GLshort *v)
{
...
static void GL_APIENTRY
_impl_glIndexMask(GLuint mask)
{
	_glptr_glIndexMask =
	    (PFN_glIndexMask)GalogenGetProcAddress("glIndexMask");
	_glptr_glIndexMask(mask);
}
PFN_glIndexMask _glptr_glIndexMask = _impl_glIndexMask;

static void GL_APIENTRY
_impl_glColor4bv(const GLbyte *v)
{
...
static void GL_APIENTRY
_impl_glVertex2fv(const GLfloat *v)
{
	_glptr_glVertex2fv =
	    (PFN_glVertex2fv)GalogenGetProcAddress("glVertex2fv");
	_glptr_glVertex2fv(v);
}
PFN_glVertex2fv _glptr_glVertex2fv = _impl_glVertex2fv;

static void GL_APIENTRY
_impl_glColor3usv(const GLushort *v)
{
	_glptr_glColor3usv =
	    (PFN_glColor3usv)GalogenGetProcAddress("glColor3usv");
	_glptr_glColor3usv(v);
}
PFN_glColor3usv _glptr_glColor3usv = _impl_glColor3usv;

static void GL_APIENTRY
_impl_glColor3uiv(const GLuint *v)
{
	_glptr_glColor3uiv =
	    (PFN_glColor3uiv)GalogenGetProcAddress("glColor3uiv");
	_glptr_glColor3uiv(v);
}
PFN_glColor3uiv _glptr_glColor3uiv = _impl_glColor3uiv;

static void GL_APIENTRY
_impl_glGenRenderbuffers(GLsizei n, GLuint *renderbuffers)
{
	_glptr_glGenRenderbuffers =
	    (PFN_glGenRenderbuffers)GalogenGetProcAddress("glGenRenderbuffers");
	_glptr_glGenRenderbuffers(n, renderbuffers);
}
PFN_glGenRenderbuffers _glptr_glGenRenderbuffers = _impl_glGenRenderbuffers;

static void GL_APIENTRY
_impl_glEdgeFlag(GLboolean flag)
{
...
static void GL_APIENTRY
_impl_glColor3i(GLint red, GLint green, GLint blue)
{
...
static void GL_APIENTRY
_impl_glUniform2iv(GLint location, GLsizei count, const GLint *value)
{
	_glptr_glUniform2iv =
	    (PFN_glUniform2iv)GalogenGetProcAddress("glUniform2iv");
	_glptr_glUniform2iv(location, count, value);
}
PFN_glUniform2iv _glptr_glUniform2iv = _impl_glUniform2iv;

static void GL_APIENTRY
_impl_glColor4dv(const GLdouble *v)
{
...
static void GL_APIENTRY
_impl_glMultMatrixd(const GLdouble *m)
{
	_glptr_glMultMatrixd =
	    (PFN_glMultMatrixd)GalogenGetProcAddress("glMultMatrixd");
	_glptr_glMultMatrixd(m);
}
PFN_glMultMatrixd _glptr_glMultMatrixd = _impl_glMultMatrixd;

static void GL_APIENTRY
_impl_glMapGrid1f(GLint un, GLfloat u1, GLfloat u2)
{
	_glptr_glMapGrid1f =
	    (PFN_glMapGrid1f)GalogenGetProcAddress("glMapGrid1f");
...
{
	_glptr_glBufferData =
	    (PFN_glBufferData)GalogenGetProcAddress("glBufferData");
	_glptr_glBufferData(target, size, data, usage);
}
PFN_glBufferData _glptr_glBufferData = _impl_glBufferData;

static void GL_APIENTRY
_impl_glBlendFuncSeparate(GLenum sfactorRGB, GLenum dfactorRGB,
    GLenum sfactorAlpha, GLenum dfactorAlpha)
{
	_glptr_glBlendFuncSeparate =
	    (PFN_glBlendFuncSeparate)GalogenGetProcAddress(
		"glBlendFuncSeparate");
	_glptr_glBlendFuncSeparate(
...
static void GL_APIENTRY
_impl_glWindowPos2d(GLdouble x, GLdouble y)
{
	_glptr_glWindowPos2d =
	    (PFN_glWindowPos2d)GalogenGetProcAddress("glWindowPos2d");
	_glptr_glWindowPos2d(x, y);
}
PFN_glWindowPos2d _glptr_glWindowPos2d = _impl_glWindowPos2d;

static void GL_APIENTRY
_impl_glTexParameteri(GLenum target, GLenum pname, GLint param)
{
	_glptr_glTexParameteri =
	    (PFN_glTexParameteri)GalogenGetProcAddress("glTexParameteri");
	_glptr_glTexParameteri(target, pname, param);
}
PFN_glTexParameteri _glptr_glTexParameteri = _impl_glTexParameteri;

static void GL_APIENTRY
_impl_glCallLists(GLsizei n, GLenum type, const void *lists)
{
	_glptr_glCallLists =
	    (PFN_glCallLists)GalogenGetProcAddress("glCallLists");
	_glptr_glCallLists(n, type, lists);
}
PFN_glCallLists _glptr_glCallLists = _impl_glCallLists;

static void GL_APIENTRY
_impl_glIndexs(GLshort c)
{
...
static void GL_APIENTRY
_impl_glVertex3i(GLint x, GLint y, GLint z)
{
...
static void GL_APIENTRY
_impl_glEvalCoord1f(GLfloat u)
{
	_glptr_glEvalCoord1f =
	    (PFN_glEvalCoord1f)GalogenGetProcAddress("glEvalCoord1f");
	_glptr_glEvalCoord1f(u);
}
PFN_glEvalCoord1f _glptr_glEvalCoord1f = _impl_glEvalCoord1f;

static void GL_APIENTRY
_impl_glIndexsv(const GLshort *c)
{
...
static void GL_APIENTRY
_impl_glColor3sv(const GLshort *v)
{
...
static void GL_APIENTRY
_impl_glColor3s(GLshort red, GLshort green, GLshort blue)
{
...
static void GL_APIENTRY
_impl_glHint(GLenum target, GLenum mode)
{
...
static void GL_APIENTRY
_impl_glColor4us(GLushort red, GLushort green, GLushort blue, GLushort alpha)
{
...
static void GL_APIENTRY
_impl_glTexCoord3s(GLshort s, GLshort t, GLshort r)
{
	_glptr_glTexCoord3s =
	    (PFN_glTexCoord3s)GalogenGetProcAddress("glTexCoord3s");
	_glptr_glTexCoord3s(s, t, r);
}
PFN_glTexCoord3s _glptr_glTexCoord3s = _impl_glTexCoord3s;

static void GL_APIENTRY
_impl_glColor4fv(const GLfloat *v)
{
...
static void GL_APIENTRY
_impl_glLoadMatrixd(const GLdouble *m)
{
	_glptr_glLoadMatrixd =
	    (PFN_glLoadMatrixd)GalogenGetProcAddress("glLoadMatrixd");
	_glptr_glLoadMatrixd(m);
}
PFN_glLoadMatrixd _glptr_glLoadMatrixd = _impl_glLoadMatrixd;

static void GL_APIENTRY
_impl_glVertexAttrib3fv(GLuint index, const GLfloat *v)
{
	_glptr_glVertexAttrib3fv =
	    (PFN_glVertexAttrib3fv)GalogenGetProcAddress("glVertexAttrib3fv");
	_glptr_glVertexAttrib3fv(index, v);
}
PFN_glVertexAttrib3fv _glptr_glVertexAttrib3fv = _impl_glVertexAttrib3fv;

static void GL_APIENTRY
_impl_glGetTexGeniv(GLenum coord, GLenum pname, GLint *params)
{
	_glptr_glGetTexGeniv =
	    (PFN_glGetTexGeniv)GalogenGetProcAddress("glGetTexGeniv");
	_glptr_glGetTexGeniv(coord, pname, params);
}
PFN_glGetTexGeniv _glptr_glGetTexGeniv = _impl_glGetTexGeniv;

static void GL_APIENTRY
_impl_glPixelZoom(GLfloat xfactor, GLfloat yfactor)
{
	_glptr_glPixelZoom =
	    (PFN_glPixelZoom)GalogenGetProcAddress("glPixelZoom");
	_glptr_glPixelZoom(xfactor, yfactor);
}
PFN_glPixelZoom _glptr_glPixelZoom = _impl_glPixelZoom;

static void GL_APIENTRY
_impl_glLightfv(GLenum light, GLenum pname, const GLfloat *params)
{
...
static void GL_APIENTRY
_impl_glRasterPos2f(GLfloat x, GLfloat y)
{
	_glptr_glRasterPos2f =
	    (PFN_glRasterPos2f)GalogenGetProcAddress("glRasterPos2f");
	_glptr_glRasterPos2f(x, y);
}
PFN_glRasterPos2f _glptr_glRasterPos2f = _impl_glRasterPos2f;

static void GL_APIENTRY
_impl_glDrawBuffer(GLenum buf)
{
	_glptr_glDrawBuffer =
	    (PFN_glDrawBuffer)GalogenGetProcAddress("glDrawBuffer");
	_glptr_glDrawBuffer(buf);
}
PFN_glDrawBuffer _glptr_glDrawBuffer = _impl_glDrawBuffer;

static GLboolean GL_APIENTRY
_impl_glIsProgram(GLuint program)
{
	_glptr_glIsProgram =
	    (PFN_glIsProgram)GalogenGetProcAddress("glIsProgram");
	return _glptr_glIsProgram(program);
}
PFN_glIsProgram _glptr_glIsProgram = _impl_glIsProgram;

static void GL_APIENTRY
_impl_glColor3bv(const GLbyte *v)
{
...
static void GL_APIENTRY
_impl_glFogCoordfv(const GLfloat *coord)
{
	_glptr_glFogCoordfv =
	    (PFN_glFogCoordfv)GalogenGetProcAddress("glFogCoordfv");
	_glptr_glFogCoordfv(coord);
}
PFN_glFogCoordfv _glptr_glFogCoordfv = _impl_glFogCoordfv;

static void GL_APIENTRY
_impl_glGetIntegerv(GLenum pname, GLint *data)
{
	_glptr_glGetIntegerv =
	    (PFN_glGetIntegerv)GalogenGetProcAddress("glGetIntegerv");
	_glptr_glGetIntegerv(pname, data);
}
PFN_glGetIntegerv _glptr_glGetIntegerv = _impl_glGetIntegerv;

static void GL_APIENTRY
_impl_glVertex2sv(const GLshort *v)
{
	_glptr_glVertex2sv =
	    (PFN_glVertex2sv)GalogenGetProcAddress("glVertex2sv");
	_glptr_glVertex2sv(v);
}
PFN_glVertex2sv _glptr_glVertex2sv = _impl_glVertex2sv;

static void GL_APIENTRY
_impl_glEnable(GLenum cap)
{
...
static void GL_APIENTRY
_impl_glVertex2s(GLshort x, GLshort y)
{
...
static void GL_APIENTRY
_impl_glMultTransposeMatrixd(const GLdouble *m)
{
	_glptr_glMultTransposeMatrixd =
	    (PFN_glMultTransposeMatrixd)GalogenGetProcAddress(
		"glMultTransposeMatrixd");
	_glptr_glMultTransposeMatrixd(m);
}
PFN_glMultTransposeMatrixd _glptr_glMultTransposeMatrixd =
    _impl_glMultTransposeMatrixd;

static void GL_APIENTRY
_impl_glBlitFramebuffer(GLint srcX0, GLint srcY0, GLint srcX1, GLint srcY1,
    GLint dstX0, GLint dstY0, GLint dstX1, GLint dstY1, GLbitfield mask,
    GLenum filter)
{
	_glptr_glBlitFramebuffer =
	    (PFN_glBlitFramebuffer)GalogenGetProcAddress("glBlitFramebuffer");
	_glptr_glBlitFramebuffer(srcX0, srcY0, srcX1, srcY1, dstX0, dstY0,
	    dstX1, dstY1, mask, filter);
}
PFN_glBlitFramebuffer _glptr_glBlitFramebuffer = _impl_glBlitFramebuffer;

static void GL_APIENTRY
_impl_glColor3f(GLfloat red, GLfloat green, GLfloat blue)
{
...
static void GL_APIENTRY
_impl_glIndexdv(const GLdouble *c)
{
...
static void GL_APIENTRY
_impl_glGetMaterialfv(GLenum face, GLenum pname, GLfloat *params)
{
	_glptr_glGetMaterialfv =
	    (PFN_glGetMaterialfv)GalogenGetProcAddress("glGetMaterialfv");
	_glptr_glGetMaterialfv(face, pname, params);
}
PFN_glGetMaterialfv _glptr_glGetMaterialfv = _impl_glGetMaterialfv;

static void GL_APIENTRY
_impl_glColor4ubv(const GLubyte *v)
{
	_glptr_glColor4ubv =
	    (PFN_glColor4ubv)GalogenGetProcAddress("glColor4ubv");
	_glptr_glColor4ubv(v);
}
PFN_glColor4ubv _glptr_glColor4ubv = _impl_glColor4ubv;

static void GL_APIENTRY
_impl_glVertex3sv(const GLshort *v)
{
	_glptr_glVertex3sv =
	    (PFN_glVertex3sv)GalogenGetProcAddress("glVertex3sv");
	_glptr_glVertex3sv(v);
}
PFN_glVertex3sv _glptr_glVertex3sv = _impl_glVertex3sv;

static void GL_APIENTRY
_impl_glRasterPos2fv(const GLfloat *v)
{
	_glptr_glRasterPos2fv =
	    (PFN_glRasterPos2fv)GalogenGetProcAddress("glRasterPos2fv");
	_glptr_glRasterPos2fv(v);
}
PFN_glRasterPos2fv _glptr_glRasterPos2fv = _impl_glRasterPos2fv;

static void GL_APIENTRY
_impl_glTexCoord3d(GLdouble s, GLdouble t, GLdouble r)
{
	_glptr_glTexCoord3d =
	    (PFN_glTexCoord3d)GalogenGetProcAddress("glTexCoord3d");
	_glptr_glTexCoord3d(s, t, r);
}
PFN_glTexCoord3d _glptr_glTexCoord3d = _impl_glTexCoord3d;

static void GL_APIENTRY
_impl_glDeleteLists(GLuint list, GLsizei range)
{
	_glptr_glDeleteLists =
	    (PFN_glDeleteLists)GalogenGetProcAddress("glDeleteLists");
	_glptr_glDeleteLists(list, range);
}
PFN_glDeleteLists _glptr_glDeleteLists = _impl_glDeleteLists;

static void GL_APIENTRY
_impl_glBeginQuery(GLenum target, GLuint id)
{
	_glptr_glBeginQuery =
	    (PFN_glBeginQuery)GalogenGetProcAddress("glBeginQuery");
	_glptr_glBeginQuery(target, id);
}
PFN_glBeginQuery _glptr_glBeginQuery = _impl_glBeginQuery;

static void GL_APIENTRY
_impl_glStencilMask(GLuint mask)
{
	_glptr_glStencilMask =
	    (PFN_glStencilMask)GalogenGetProcAddress("glStencilMask");
	_glptr_glStencilMask(mask);
}
PFN_glStencilMask _glptr_glStencilMask = _impl_glStencilMask;

static void GL_APIENTRY
_impl_glPolygonStipple(const GLubyte *mask)
{
	_glptr_glPolygonStipple =
	    (PFN_glPolygonStipple)GalogenGetProcAddress("glPolygonStipple");
	_glptr_glPolygonStipple(mask);
}
PFN_glPolygonStipple _glptr_glPolygonStipple = _impl_glPolygonStipple;

static void GL_APIENTRY
_impl_glMateriali(GLenum face, GLenum pname, GLint param)
{
	_glptr_glMateriali =
	    (PFN_glMateriali)GalogenGetProcAddress("glMateriali");
	_glptr_glMateriali(face, pname, param);
}
PFN_glMateriali _glptr_glMateriali = _impl_glMateriali;

static void GL_APIENTRY
_impl_glRectsv(const GLshort *v1, const GLshort *v2)
{
...
static void GL_APIENTRY
_impl_glAttachShader(GLuint program, GLuint shader)
{
	_glptr_glAttachShader =
	    (PFN_glAttachShader)GalogenGetProcAddress("glAttachShader");
	_glptr_glAttachShader(program, shader);
}
PFN_glAttachShader _glptr_glAttachShader = _impl_glAttachShader;

static void GL_APIENTRY
_impl_glPointSize(GLfloat size)
{
	_glptr_glPointSize =
	    (PFN_glPointSize)GalogenGetProcAddress("glPointSize");
...
static void GL_APIENTRY
_impl_glMultiDrawElements(GLenum mode, const GLsizei *count, GLenum type,
    const void *const *indices, GLsizei drawcount)
{
	_glptr_glMultiDrawElements =
	    (PFN_glMultiDrawElements)GalogenGetProcAddress(
		"glMultiDrawElements");
...
static void GL_APIENTRY
_impl_glNormal3fv(const GLfloat *v)
{
	_glptr_glNormal3fv =
	    (PFN_glNormal3fv)GalogenGetProcAddress("glNormal3fv");
	_glptr_glNormal3fv(v);
}
PFN_glNormal3fv _glptr_glNormal3fv = _impl_glNormal3fv;

static void GL_APIENTRY
_impl_glGetTexParameterfv(GLenum target, GLenum pname, GLfloat *params)
{
	_glptr_glGetTexParameterfv =
	    (PFN_glGetTexParameterfv)GalogenGetProcAddress(
		"glGetTexParameterfv");
...
static void GL_APIENTRY
_impl_glColor4ub(GLubyte red, GLubyte green, GLubyte blue, GLubyte alpha)
{
...
static void GL_APIENTRY
_impl_glAlphaFunc(GLenum func, GLfloat ref)
{
	_glptr_glAlphaFunc =
	    (PFN_glAlphaFunc)GalogenGetProcAddress("glAlphaFunc");
	_glptr_glAlphaFunc(func, ref);
}
PFN_glAlphaFunc _glptr_glAlphaFunc = _impl_glAlphaFunc;

static GLboolean GL_APIENTRY
_impl_glIsEnabled(GLenum cap)
{
	_glptr_glIsEnabled =
...
static void GL_APIENTRY
_impl_glGetTexLevelParameteriv(
    GLenum target, GLint level, GLenum pname, GLint *params)
{
	_glptr_glGetTexLevelParameteriv =
	    (PFN_glGetTexLevelParameteriv)GalogenGetProcAddress(
		"glGetTexLevelParameteriv");
	_glptr_glGetTexLevelParameteriv(target, level, pname, params);
}
PFN_glGetTexLevelParameteriv _glptr_glGetTexLevelParameteriv =
    _impl_glGetTexLevelParameteriv;
...
static void GL_APIENTRY
_impl_glEndTransformFeedback()
{
	_glptr_glEndTransformFeedback =
	    (PFN_glEndTransformFeedback)GalogenGetProcAddress(
		"glEndTransformFeedback");
	_glptr_glEndTransformFeedback();
}
PFN_glEndTransformFeedback _glptr_glEndTransformFeedback =
    _impl_glEndTransformFeedback;

static void GL_APIENTRY
_impl_glWindowPos2i(GLint x, GLint y)
{
	_glptr_glWindowPos2i =
	    (PFN_glWindowPos2i)GalogenGetProcAddress("glWindowPos2i");
	_glptr_glWindowPos2i(x, y);
}
PFN_glWindowPos2i _glptr_glWindowPos2i = _impl_glWindowPos2i;

static void GL_APIENTRY
_impl_glClearColor(GLfloat red, GLfloat green, GLfloat blue, GLfloat alpha)
{
	_glptr_glClearColor =
	    (PFN_glClearColor)GalogenGetProcAddress("glClearColor");
	_glptr_glClearColor(red, green, blue, alpha);
}
PFN_glClearColor _glptr_glClearColor = _impl_glClearColor;

static void GL_APIENTRY
_impl_glMultTransposeMatrixf(const GLfloat *m)
{
	_glptr_glMultTransposeMatrixf =
	    (PFN_glMultTransposeMatrixf)GalogenGetProcAddress(
		"glMultTransposeMatrixf");
	_glptr_glMultTransposeMatrixf(m);
}
PFN_glMultTransposeMatrixf _glptr_glMultTransposeMatrixf =
    _impl_glMultTransposeMatrixf;

static void GL_APIENTRY
_impl_glColor3ubv(const GLubyte *v)
{
	_glptr_glColor3ubv =
	    (PFN_glColor3ubv)GalogenGetProcAddress("glColor3ubv");
	_glptr_glColor3ubv(v);
}
PFN_glColor3ubv _glptr_glColor3ubv = _impl_glColor3ubv;

static void GL_APIENTRY
_impl_glBlendColor(GLfloat red, GLfloat green, GLfloat blue, GLfloat alpha)
{
	_glptr_glBlendColor =
	    (PFN_glBlendColor)GalogenGetProcAddress("glBlendColor");
	_glptr_glBlendColor(red, green, blue, alpha);
}
PFN_glBlendColor _glptr_glBlendColor = _impl_glBlendColor;

static void GL_APIENTRY
_impl_glRects(GLshort x1, GLshort y1, GLshort x2, GLshort y2)
{
...
static void GL_APIENTRY
_impl_glVertexAttribI3i(GLuint index, GLint x, GLint y, GLint z)
{
	_glptr_glVertexAttribI3i =
	    (PFN_glVertexAttribI3i)GalogenGetProcAddress("glVertexAttribI3i");
	_glptr_glVertexAttribI3i(index, x, y, z);
}
PFN_glVertexAttribI3i _glptr_glVertexAttribI3i = _impl_glVertexAttribI3i;

static void GL_APIENTRY
_impl_glMatrixMode(GLenum mode)
{
	_glptr_glMatrixMode =
	    (PFN_glMatrixMode)GalogenGetProcAddress("glMatrixMode");
	_glptr_glMatrixMode(mode);
}
PFN_glMatrixMode _glptr_glMatrixMode = _impl_glMatrixMode;

static void GL_APIENTRY
_impl_glRasterPos3dv(const GLdouble *v)
{
	_glptr_glRasterPos3dv =
	    (PFN_glRasterPos3dv)GalogenGetProcAddress("glRasterPos3dv");
	_glptr_glRasterPos3dv(v);
}
PFN_glRasterPos3dv _glptr_glRasterPos3dv = _impl_glRasterPos3dv;

static void GL_APIENTRY
_impl_glCompressedTexSubImage3D(GLenum target, GLint level, GLint xoffset,
    GLint yoffset, GLint zoffset, GLsizei width, GLsizei height, GLsizei depth,
    GLenum format, GLsizei imageSize, const void *data)
{
	_glptr_glCompressedTexSubImage3D =
	    (PFN_glCompressedTexSubImage3D)GalogenGetProcAddress(
		"glCompressedTexSubImage3D");
	_glptr_glCompressedTexSubImage3D(target, level, xoffset, yoffset,
	    zoffset, width, height, depth, format, imageSize, data);
}
PFN_glCompressedTexSubImage3D _glptr_glCompressedTexSubImage3D =
    _impl_glCompressedTexSubImage3D;

static void GL_APIENTRY
_impl_glWindowPos2iv(const GLint *v)
{
	_glptr_glWindowPos2iv =
	    (PFN_glWindowPos2iv)GalogenGetProcAddress("glWindowPos2iv");
	_glptr_glWindowPos2iv(v);
}
PFN_glWindowPos2iv _glptr_glWindowPos2iv = _impl_glWindowPos2iv;

static void GL_APIENTRY
_impl_glVertex4f(GLfloat x, GLfloat y, GLfloat z, GLfloat w)
{
...
static void GL_APIENTRY
_impl_glReadPixels(GLint x, GLint y, GLsizei width, GLsizei height,
    GLenum format, GLenum type, void *pixels)
{
	_glptr_glReadPixels =
	    (PFN_glReadPixels)GalogenGetProcAddress("glReadPixels");
	_glptr_glReadPixels(x, y, width, height, format, type, pixels);
}
PFN_glReadPixels _glptr_glReadPixels = _impl_glReadPixels;

static void GL_APIENTRY
_impl_glTexParameterf(GLenum target, GLenum pname, GLfloat param)
{
	_glptr_glTexParameterf =
	    (PFN_glTexParameterf)GalogenGetProcAddress("glTexParameterf");
	_glptr_glTexParameterf(target, pname, param);
}
PFN_glTexParameterf _glptr_glTexParameterf = _impl_glTexParameterf;

static void GL_APIENTRY
_impl_glPointParameterfv(GLenum pname, const GLfloat *params)
{
	_glptr_glPointParameterfv =
	    (PFN_glPointParameterfv)GalogenGetProcAddress("glPointParameterfv");
	_glptr_glPointParameterfv(pname, params);
}
PFN_glPointParameterfv _glptr_glPointParameterfv = _impl_glPointParameterfv;

static void GL_APIENTRY
_impl_glColor4d(GLdouble red, GLdouble green, GLdouble blue, GLdouble alpha)
{
...
static void GL_APIENTRY
_impl_glGetShaderInfoLog(
    GLuint shader, GLsizei bufSize, GLsizei *length, GLchar *infoLog)
{
	_glptr_glGetShaderInfoLog =
	    (PFN_glGetShaderInfoLog)GalogenGetProcAddress("glGetShaderInfoLog");
...
static void GL_APIENTRY
_impl_glWindowPos2f(GLfloat x, GLfloat y)
{
	_glptr_glWindowPos2f =
	    (PFN_glWindowPos2f)GalogenGetProcAddress("glWindowPos2f");
	_glptr_glWindowPos2f(x, y);
}
PFN_glWindowPos2f _glptr_glWindowPos2f = _impl_glWindowPos2f;

static void GL_APIENTRY
_impl_glMultiTexCoord4d(
    GLenum target, GLdouble s, GLdouble t, GLdouble r, GLdouble q)
{
	_glptr_glMultiTexCoord4d =
	    (PFN_glMultiTexCoord4d)GalogenGetProcAddress("glMultiTexCoord4d");
	_glptr_glMultiTexCoord4d(target, s, t, r, q);
}
PFN_glMultiTexCoord4d _glptr_glMultiTexCoord4d = _impl_glMultiTexCoord4d;

static void GL_APIENTRY
_impl_glGetPixelMapfv(GLenum map, GLfloat *values)
{
	_glptr_glGetPixelMapfv =
	    (PFN_glGetPixelMapfv)GalogenGetProcAddress("glGetPixelMapfv");
	_glptr_glGetPixelMapfv(map, values);
}
PFN_glGetPixelMapfv _glptr_glGetPixelMapfv = _impl_glGetPixelMapfv;

static void GL_APIENTRY
_impl_glRectf(GLfloat x1, GLfloat y1, GLfloat x2, GLfloat y2)
{
...
static void GL_APIENTRY
_impl_glDepthFunc(GLenum func)
{
	_glptr_glDepthFunc =
	    (PFN_glDepthFunc)GalogenGetProcAddress("glDepthFunc");
	_glptr_glDepthFunc(func);
}
PFN_glDepthFunc _glptr_glDepthFunc = _impl_glDepthFunc;

static void GL_APIENTRY
_impl_glVertexAttribI3uiv(GLuint index, const GLuint *v)
{
	_glptr_glVertexAttribI3uiv =
	    (PFN_glVertexAttribI3uiv)GalogenGetProcAddress(
		"glVertexAttribI3uiv");
...
static void GL_APIENTRY
_impl_glFogiv(GLenum pname, const GLint *params)
{
...
static void GL_APIENTRY
_impl_glNewList(GLuint list, GLenum mode)
{
...
static void GL_APIENTRY
_impl_glFogCoordPointer(GLenum type, GLsizei stride, const void *pointer)
{
	_glptr_glFogCoordPointer =
	    (PFN_glFogCoordPointer)GalogenGetProcAddress("glFogCoordPointer");
	_glptr_glFogCoordPointer(type, stride, pointer);
}
PFN_glFogCoordPointer _glptr_glFogCoordPointer = _impl_glFogCoordPointer;

static void GL_APIENTRY
_impl_glMultiTexCoord1fv(GLenum target, const GLfloat *v)
{
	_glptr_glMultiTexCoord1fv =
	    (PFN_glMultiTexCoord1fv)GalogenGetProcAddress("glMultiTexCoord1fv");
	_glptr_glMultiTexCoord1fv(target, v);
}
PFN_glMultiTexCoord1fv _glptr_glMultiTexCoord1fv = _impl_glMultiTexCoord1fv;

static void GL_APIENTRY
_impl_glStencilOp(GLenum fail, GLenum zfail, GLenum zpass)
{
	_glptr_glStencilOp =
	    (PFN_glStencilOp)GalogenGetProcAddress("glStencilOp");
	_glptr_glStencilOp(fail, zfail, zpass);
}
PFN_glStencilOp _glptr_glStencilOp = _impl_glStencilOp;

static void GL_APIENTRY
_impl_glTexEnvf(GLenum target, GLenum pname, GLfloat param)
{
...
static void GL_APIENTRY
_impl_glStencilFunc(GLenum func, GLint ref, GLuint mask)
{
	_glptr_glStencilFunc =
	    (PFN_glStencilFunc)GalogenGetProcAddress("glStencilFunc");
	_glptr_glStencilFunc(func, ref, mask);
}
PFN_glStencilFunc _glptr_glStencilFunc = _impl_glStencilFunc;

static void GL_APIENTRY
_impl_glColor4b(GLbyte red, GLbyte green, GLbyte blue, GLbyte alpha)
{
...
static void GL_APIENTRY
_impl_glEnableVertexAttribArray(GLuint index)
{
	_glptr_glEnableVertexAttribArray =
	    (PFN_glEnableVertexAttribArray)GalogenGetProcAddress(
		"glEnableVertexAttribArray");
	_glptr_glEnableVertexAttribArray(index);
}
PFN_glEnableVertexAttribArray _glptr_glEnableVertexAttribArray =
    _impl_glEnableVertexAttribArray;

static void GL_APIENTRY
_impl_glBlendFunc(GLenum sfactor, GLenum dfactor)
{
	_glptr_glBlendFunc =
	    (PFN_glBlendFunc)GalogenGetProcAddress("glBlendFunc");
	_glptr_glBlendFunc(sfactor, dfactor);
}
PFN_glBlendFunc _glptr_glBlendFunc = _impl_glBlendFunc;

static void GL_APIENTRY
_impl_glTexCoord3sv(const GLshort *v)
{
	_glptr_glTexCoord3sv =
	    (PFN_glTexCoord3sv)GalogenGetProcAddress("glTexCoord3sv");
	_glptr_glTexCoord3sv(v);
}
PFN_glTexCoord3sv _glptr_glTexCoord3sv = _impl_glTexCoord3sv;

static void GL_APIENTRY
_impl_glShadeModel(GLenum mode)
{
	_glptr_glShadeModel =
	    (PFN_glShadeModel)GalogenGetProcAddress("glShadeModel");
	_glptr_glShadeModel(mode);
}
PFN_glShadeModel _glptr_glShadeModel = _impl_glShadeModel;

static void GL_APIENTRY
_impl_glColor3fv(const GLfloat *v)
{
...
static void GL_APIENTRY
_impl_glTexCoord2iv(const GLint *v)
{
	_glptr_glTexCoord2iv =
	    (PFN_glTexCoord2iv)GalogenGetProcAddress("glTexCoord2iv");
	_glptr_glTexCoord2iv(v);
}
PFN_glTexCoord2iv _glptr_glTexCoord2iv = _impl_glTexCoord2iv;

static void GL_APIENTRY
_impl_glVertexAttrib4Nub(
    GLuint index, GLubyte x, GLubyte y, GLubyte z, GLubyte w)
{
	_glptr_glVertexAttrib4Nub =
	    (PFN_glVertexAttrib4Nub)GalogenGetProcAddress("glVertexAttrib4Nub");
	_glptr_glVertexAttrib4Nub(index, x, y, z, w);
}
PFN_glVertexAttrib4Nub _glptr_glVertexAttrib4Nub = _impl_glVertexAttrib4Nub;

static void GL_APIENTRY
_impl_glTexCoord2dv(const GLdouble *v)
{
	_glptr_glTexCoord2dv =
	    (PFN_glTexCoord2dv)GalogenGetProcAddress("glTexCoord2dv");
	_glptr_glTexCoord2dv(v);
}
PFN_glTexCoord2dv _glptr_glTexCoord2dv = _impl_glTexCoord2dv;

static void GL_APIENTRY
_impl_glColor4usv(const GLushort *v)
{
	_glptr_glColor4usv =
	    (PFN_glColor4usv)GalogenGetProcAddress("glColor4usv");
	_glptr_glColor4usv(v);
}
PFN_glColor4usv _glptr_glColor4usv = _impl_glColor4usv;

static void GL_APIENTRY
_impl_glLineStipple(GLint factor, GLushort pattern)
{
	_glptr_glLineStipple =
	    (PFN_glLineStipple)GalogenGetProcAddress("glLineStipple");
	_glptr_glLineStipple(factor, pattern);
}
PFN_glLineStipple _glptr_glLineStipple = _impl_glLineStipple;

static void GL_APIENTRY
_impl_glUniform1fv(GLint location, GLsizei count, const GLfloat *value)
{
	_glptr_glUniform1fv =
	    (PFN_glUniform1fv)GalogenGetProcAddress("glUniform1fv");
	_glptr_glUniform1fv(location, count, value);
}
PFN_glUniform1fv _glptr_glUniform1fv = _impl_glUniform1fv;

static void GL_APIENTRY
_impl_glVertex4iv(const GLint *v)
{
	_glptr_glVertex4iv =
	    (PFN_glVertex4iv)GalogenGetProcAddress("glVertex4iv");
	_glptr_glVertex4iv(v);
}
PFN_glVertex4iv _glptr_glVertex4iv = _impl_glVertex4iv;

static void GL_APIENTRY
_impl_glPixelStorei(GLenum pname, GLint param)
{
	_glptr_glPixelStorei =
	    (PFN_glPixelStorei)GalogenGetProcAddress("glPixelStorei");
	_glptr_glPixelStorei(pname, param);
}
PFN_glPixelStorei _glptr_glPixelStorei = _impl_glPixelStorei;

static void GL_APIENTRY
_impl_glGetTexEnvfv(GLenum target, GLenum pname, GLfloat *params)
{
	_glptr_glGetTexEnvfv =
	    (PFN_glGetTexEnvfv)GalogenGetProcAddress("glGetTexEnvfv");
	_glptr_glGetTexEnvfv(target, pname, params);
}
PFN_glGetTexEnvfv _glptr_glGetTexEnvfv = _impl_glGetTexEnvfv;

static void GL_APIENTRY
_impl_glLineWidth(GLfloat width)
{
	_glptr_glLineWidth =
	    (PFN_glLineWidth)GalogenGetProcAddress("glLineWidth");
	_glptr_glLineWidth(width);
}
PFN_glLineWidth _glptr_glLineWidth = _impl_glLineWidth;

static void GL_APIENTRY
_impl_glCallList(GLuint list)
{
...
static void GL_APIENTRY
_impl_glGetUniformiv(GLuint program, GLint location, GLint *params)
{
	_glptr_glGetUniformiv =
	    (PFN_glGetUniformiv)GalogenGetProcAddress("glGetUniformiv");
	_glptr_glGetUniformiv(program, location, params);
}
PFN_glGetUniformiv _glptr_glGetUniformiv = _impl_glGetUniformiv;

static void GL_APIENTRY
_impl_glVertex2i(GLint x, GLint y)
{
...
static void GL_APIENTRY
_impl_glReadBuffer(GLenum src)
{
	_glptr_glReadBuffer =
	    (PFN_glReadBuffer)GalogenGetProcAddress("glReadBuffer");
	_glptr_glReadBuffer(src);
}
PFN_glReadBuffer _glptr_glReadBuffer = _impl_glReadBuffer;

static void GL_APIENTRY
_impl_glTexImage1D(GLenum target, GLint level, GLint internalformat,
    GLsizei width, GLint border, GLenum format, GLenum type, const void *pixels)
{
	_glptr_glTexImage1D =
	    (PFN_glTexImage1D)GalogenGetProcAddress("glTexImage1D");
	_glptr_glTexImage1D(
...
static void GL_APIENTRY
_impl_glRasterPos2sv(const GLshort *v)
{
	_glptr_glRasterPos2sv =
	    (PFN_glRasterPos2sv)GalogenGetProcAddress("glRasterPos2sv");
	_glptr_glRasterPos2sv(v);
}
PFN_glRasterPos2sv _glptr_glRasterPos2sv = _impl_glRasterPos2sv;

static void GL_APIENTRY
_impl_glTexCoord3dv(const GLdouble *v)
{
	_glptr_glTexCoord3dv =
	    (PFN_glTexCoord3dv)GalogenGetProcAddress("glTexCoord3dv");
	_glptr_glTexCoord3dv(v);
}
PFN_glTexCoord3dv _glptr_glTexCoord3dv = _impl_glTexCoord3dv;

static GLuint GL_APIENTRY
_impl_glGenLists(GLsizei range)
{
...
static void GL_APIENTRY
_impl_glTexParameterfv(GLenum target, GLenum pname, const GLfloat *params)
{
	_glptr_glTexParameterfv =
	    (PFN_glTexParameterfv)GalogenGetProcAddress("glTexParameterfv");
	_glptr_glTexParameterfv(target, pname, params);
}
PFN_glTexParameterfv _glptr_glTexParameterfv = _impl_glTexParameterfv;

static void GL_APIENTRY
_impl_glTexEnvi(GLenum target, GLenum pname, GLint param)
{
...
static void GL_APIENTRY
_impl_glVertexAttrib3s(GLuint index, GLshort x, GLshort y, GLshort z)
{
	_glptr_glVertexAttrib3s =
	    (PFN_glVertexAttrib3s)GalogenGetProcAddress("glVertexAttrib3s");
	_glptr_glVertexAttrib3s(index, x, y, z);
}
PFN_glVertexAttrib3s _glptr_glVertexAttrib3s = _impl_glVertexAttrib3s;

static void GL_APIENTRY
_impl_glTexCoord3iv(const GLint *v)
{
	_glptr_glTexCoord3iv =
	    (PFN_glTexCoord3iv)GalogenGetProcAddress("glTexCoord3iv");
	_glptr_glTexCoord3iv(v);
}
PFN_glTexCoord3iv _glptr_glTexCoord3iv = _impl_glTexCoord3iv;

static void GL_APIENTRY
_impl_glIndexfv(const GLfloat *c)
{
...
static void GL_APIENTRY
_impl_glCompressedTexSubImage1D(GLenum target, GLint level, GLint xoffset,
    GLsizei width, GLenum format, GLsizei imageSize, const void *data)
{
	_glptr_glCompressedTexSubImage1D =
	    (PFN_glCompressedTexSubImage1D)GalogenGetProcAddress(
		"glCompressedTexSubImage1D");
	_glptr_glCompressedTexSubImage1D(
	    target, level, xoffset, width, format, imageSize, data);
}
PFN_glCompressedTexSubImage1D _glptr_glCompressedTexSubImage1D =
    _impl_glCompressedTexSubImage1D;

static void GL_APIENTRY
_impl_glVertexPointer(
    GLint size, GLenum type, GLsizei stride, const void *pointer)
{
	_glptr_glVertexPointer =
	    (PFN_glVertexPointer)GalogenGetProcAddress("glVertexPointer");
...
{
	_glptr_glMapGrid2d =
	    (PFN_glMapGrid2d)GalogenGetProcAddress("glMapGrid2d");
	_glptr_glMapGrid2d(un, u1, u2, vn, v1, v2);
}
PFN_glMapGrid2d _glptr_glMapGrid2d = _impl_glMapGrid2d;

static void GL_APIENTRY
_impl_glRecti(GLint x1, GLint y1, GLint x2, GLint y2)
{
...
static void GL_APIENTRY
_impl_glTexImage2D(GLenum target, GLint level, GLint internalformat,
    GLsizei width, GLsizei height, GLint border, GLenum format, GLenum type,
    const void *pixels)
{
	_glptr_glTexImage2D =
	    (PFN_glTexImage2D)GalogenGetProcAddress("glTexImage2D");
	_glptr_glTexImage2D(target, level, internalformat, width, height,
	    border, format, type, pixels);
}
PFN_glTexImage2D _glptr_glTexImage2D = _impl_glTexImage2D;

static void GL_APIENTRY
_impl_glVertexAttrib4Niv(GLuint index, const GLint *v)
{
	_glptr_glVertexAttrib4Niv =
	    (PFN_glVertexAttrib4Niv)GalogenGetProcAddress("glVertexAttrib4Niv");
	_glptr_glVertexAttrib4Niv(index, v);
}
PFN_glVertexAttrib4Niv _glptr_glVertexAttrib4Niv = _impl_glVertexAttrib4Niv;

static void GL_APIENTRY
_impl_glLightf(GLenum light, GLenum pname, GLfloat param)
{
...
static void GL_APIENTRY
_impl_glGetVertexAttribIuiv(GLuint index, GLenum pname, GLuint *params)
{
	_glptr_glGetVertexAttribIuiv =
	    (PFN_glGetVertexAttribIuiv)GalogenGetProcAddress(
		"glGetVertexAttribIuiv");
	_glptr_glGetVertexAttribIuiv(index, pname, params);
}
PFN_glGetVertexAttribIuiv _glptr_glGetVertexAttribIuiv =
    _impl_glGetVertexAttribIuiv;

static void GL_APIENTRY
_impl_glStencilMaskSeparate(GLenum face, GLuint mask)
{
	_glptr_glStencilMaskSeparate =
	    (PFN_glStencilMaskSeparate)GalogenGetProcAddress(
		"glStencilMaskSeparate");
	_glptr_glStencilMaskSeparate(face, mask);
}
PFN_glStencilMaskSeparate _glptr_glStencilMaskSeparate =
    _impl_glStencilMaskSeparate;

static void GL_APIENTRY
_impl_glWindowPos2fv(const GLfloat *v)
{
	_glptr_glWindowPos2fv =
	    (PFN_glWindowPos2fv)GalogenGetProcAddress("glWindowPos2fv");
	_glptr_glWindowPos2fv(v);
}
PFN_glWindowPos2fv _glptr_glWindowPos2fv = _impl_glWindowPos2fv;

static void GL_APIENTRY
_impl_glRectiv(const GLint *v1, const GLint *v2)
{
...
static void GL_APIENTRY
_impl_glColor4ui(GLuint red, GLuint green, GLuint blue, GLuint alpha)
{
...
static void GL_APIENTRY
_impl_glColor4s(GLshort red, GLshort green, GLshort blue, GLshort alpha)
{
...
static void GL_APIENTRY
_impl_glInterleavedArrays(GLenum format, GLsizei stride, const void *pointer)
{
	_glptr_glInterleavedArrays =
	    (PFN_glInterleavedArrays)GalogenGetProcAddress(
		"glInterleavedArrays");
...
static void GL_APIENTRY
_impl_glGenVertexArrays(GLsizei n, GLuint *arrays)
{
	_glptr_glGenVertexArrays =
	    (PFN_glGenVertexArrays)GalogenGetProcAddress("glGenVertexArrays");
	_glptr_glGenVertexArrays(n, arrays);
}
PFN_glGenVertexArrays _glptr_glGenVertexArrays = _impl_glGenVertexArrays;

static void GL_APIENTRY
_impl_glFrontFace(GLenum mode)
{
	_glptr_glFrontFace =
	    (PFN_glFrontFace)GalogenGetProcAddress("glFrontFace");
	_glptr_glFrontFace(mode);
}
PFN_glFrontFace _glptr_glFrontFace = _impl_glFrontFace;

static void GL_APIENTRY
_impl_glDepthRange(GLdouble n, GLdouble f)
{
	_glptr_glDepthRange =
	    (PFN_glDepthRange)GalogenGetProcAddress("glDepthRange");
	_glptr_glDepthRange(n, f);
}
PFN_glDepthRange _glptr_glDepthRange = _impl_glDepthRange;

static void GL_APIENTRY
_impl_glVertexAttrib4s(GLuint index, GLshort x, GLshort y, GLshort z, GLshort w)
{
	_glptr_glVertexAttrib4s =
	    (PFN_glVertexAttrib4s)GalogenGetProcAddress("glVertexAttrib4s");
	_glptr_glVertexAttrib4s(index, x, y, z, w);
}
PFN_glVertexAttrib4s _glptr_glVertexAttrib4s = _impl_glVertexAttrib4s;

static void GL_APIENTRY
_impl_glDetachShader(GLuint program, GLuint shader)
{
	_glptr_glDetachShader =
	    (PFN_glDetachShader)GalogenGetProcAddress("glDetachShader");
	_glptr_glDetachShader(program, shader);
}
PFN_glDetachShader _glptr_glDetachShader = _impl_glDetachShader;

static void GL_APIENTRY
_impl_glCullFace(GLenum mode)
{
